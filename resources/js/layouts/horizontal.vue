        ...
        <div id="layout-wrapper">
            ...
            <span class="logo-sm">
              ...
              <img alt="" height="17" src="@/assets/images/logo-light.png"/>
                    ...
                    <button id="vertical-hover" class="
              btn btn-sm
              p-0
              fs-20
              header-item
                ...
                <div id="scrollbar">
                    <b-container fluid>
                        <ul id="navbar-nav" class="navbar-nav h-100">
                            ...
                            <li class="nav-item">
                                <b-link aria-controls="sidebarDashboards" aria-expanded="false" class="nav-link menu-link"
                            ...
                            <!-- end Dashboard Menu -->
                            <li class="nav-item">
                                <b-link aria-controls="sidebarApps" aria-expanded="false" class="nav-link menu-link"
                                        data-bs-toggle="collapse"
                                ...
                                <div id="sidebarApps" class="collapse menu-dropdown">
                                    <ul class="nav nav-sm flex-column">
                                                            ...
                                                            <ul class="nav nav-sm flex-column">
                                                                <li class="nav-item">
                                                                    <router-link class="nav-link"
                                                                                 data-key="t-products" to="/email/email-basic">
                                                                        {{ $t("t-basic-action") }}
                                                                    </router-link>
                                                                </li>
                                                                <li class="nav-item">
                                                                    <router-link class="nav-link"
                                                                                 data-key="t-products" to="/email/email-ecommerce">
                                        ...
                                        <li class="nav-item">
                                            <b-link aria-controls="sidebarProjects" aria-expanded="false" class="nav-link"
                                                    data-bs-toggle="collapse"
                                        ...
                                        <li class="nav-item">
                                            <b-link aria-controls="sidebarInvoices" aria-expanded="false" class="nav-link"
                                                    data-bs-toggle="collapse"
                                        ...
                                        <li class="nav-item">
                                            <b-link aria-controls="sidebarTickets" aria-expanded="false" class="nav-link"
                                                    data-bs-toggle="collapse"
                                        ...
                                        <li class="nav-item">
                                            <b-link aria-controls="nftmarketplace" aria-expanded="false" class="nav-link"
                                                    data-bs-toggle="collapse"
                                        ...
                                        <li class="nav-item">
                                            <b-link aria-controls="sidebarjobs" aria-expanded="false" class="nav-link"
                                                    data-bs-toggle="collapse"
                                                    data-key="t-jobs" href="#sidebarjobs" role="button">
                                                {{ $t("t-jobs") }}
                                            </b-link>
                                            <div id="sidebarjobs" class="collapse menu-dropdown">
                                                <ul class="nav nav-sm flex-column">
                                                    <li class="nav-item">
                                                        <router-link class="nav-link" data-key="t-statistics"
                                                                     to="/jobs/statistics">
                                                            {{ $t("t-statistics") }}
                                                        </router-link>
                                                    </li>
                                                    <li class="nav-item">
                                                        <b-link aria-controls="sidebarjoblists" aria-expanded="false"
                                                                class="nav-link" data-bs-toggle="collapse"
                                                                data-key="t-projects" href="#sidebarjoblists"
                                                                role="button">
                                                            {{ $t("t-job-lists") }}
                                                        </b-link>
                                                        <div id="sidebarjoblists" class="collapse menu-dropdown">
                                                            <ul class="nav nav-sm flex-column">
                                                                <li class="nav-item">
                                                                    <router-link class="nav-link" data-key="t-list"
                                                                                 to="/jobs/lists">
                                                    ...
                                                    <li class="nav-item">
                                                        <b-link aria-controls="sidebarcandidatelists" aria-expanded="false"
                                                                class="nav-link"
                                                                data-bs-toggle="collapse" data-key="t-projects"
                                                        ...
                                                        <div id="sidebarcandidatelists" class="collapse menu-dropdown">
                                                            <ul class="nav nav-sm flex-column">
                                                                <li class="nav-item">
                                                                    <router-link class="nav-link"
                                                                                 data-key="t-list" to="/jobs/candidate-lists">
                                                                        {{ $t("t-list-view") }}
                                                                    </router-link>
                                                                </li>
                                                                <li class="nav-item">
                                                    ...
                                                    <li class="nav-item">
                                                        <router-link class="nav-link" data-key="t-categories"
                                                                     to="/jobs/categories">
                                                            {{ $t("t-job-categories") }}
                                                        </router-link>
                                                    </li>
                            ...
                            <li class="nav-item">
                                <b-link aria-controls="sidebarAuth" aria-expanded="false" class="nav-link menu-link"
                                        data-bs-toggle="collapse"
                                ...
                                <div id="sidebarAuth" class="collapse menu-dropdown">
                                    <ul class="nav nav-sm flex-column">
                                                ...
                                                <ul class="nav nav-sm flex-column">
                                                    <li class="nav-item">
                                                        <router-link class="nav-link" data-key="t-basic"
                                                                     to="/auth/signin-basic">{{ $t("t-basic") }}
                                                        </router-link>
                                                    </li>
                                                    <li class="nav-item">
                                                        <router-link class="nav-link" data-key="t-cover"
                                                                     to="/auth/signin-cover">{{ $t("t-cover") }}
                                                        </router-link>
                                                    </li>
                                                </ul>
                                            </div>
                                        ...
                                        <li class="nav-item">
                                            ...
                                            <div id="sidebarSignUp" class="collapse menu-dropdown">
                                                <ul class="nav nav-sm flex-column">
                                                    <li class="nav-item">
                                                        <router-link class="nav-link" data-key="t-basic"
                                                                     to="/auth/signup-basic">{{ $t("t-basic") }}
                                                        </router-link>
                                                    </li>
                                                    <li class="nav-item">
                                                        <router-link class="nav-link" data-key="t-cover"
                                                                     to="/auth/signup-cover">{{ $t("t-cover") }}
                                                        </router-link>
                                                    </li>
                                                </ul>
                                            </div>
                                        ...
                                        <li class="nav-item">
                                            <b-link aria-controls="sidebarcreatepass" aria-expanded="false" class="nav-link"
                                                    data-bs-toggle="collapse"
                                        ...
                                        <li class="nav-item">
                                            <b-link aria-controls="sidebarTwoStep" aria-expanded="false" class="nav-link"
                                                    data-bs-toggle="collapse"
                                        ...
                                        <li class="nav-item">
                                            ...
                                            <div id="sidebarErrors" class="collapse menu-dropdown">
                                                <ul class="nav nav-sm flex-column">
                                                    ...
                                                    <li class="nav-item">
                                                        <router-link class="nav-link" data-key="t-ofline-page"
                                                                     to="/auth/ofline">
                                                            {{ $t("t-offline-page") }}
                                                        </router-link>
                                                    </li>
                            ...
                            <li class="nav-item">
                                <b-link aria-controls="sidebarPages" aria-expanded="false" class="nav-link menu-link"
                                        data-bs-toggle="collapse"
                                ...
                                <div id="sidebarPages" class="collapse menu-dropdown">
                                    <ul class="nav nav-sm flex-column">
                                        ...
                                        <li class="nav-item">
                                            <b-link aria-controls="sidebarProfile" aria-expanded="false" class="nav-link"
                                                    data-bs-toggle="collapse"
                                                    data-key="t-profile" href="#sidebarProfile"
                                                    role="button">{{ $t("t-profile") }}
                                            </b-link>
                            ...
                            <li class="nav-item">
                                <b-link aria-controls="sidebarlanding" aria-expanded="false" class="nav-link" data-bs-toggle="collapse"
                                        data-key="t-projects" href="#sidebarlanding" role="button">
                            ...
                            <li class="nav-item">
                                <b-link aria-controls="sidebarUI" aria-expanded="false" class="nav-link menu-link"
                                        data-bs-toggle="collapse"
                            ...
                            <li class="nav-item">
                                <b-link aria-controls="sidebarMore" aria-expanded="false" class="nav-link active"
                                        data-bs-toggle="collapse"
                                        href="#sidebarMore" role="button">
                                    <i class="ri-briefcase-2-line"></i> More
                                </b-link>
                                <div id="sidebarMore" class="collapse menu-dropdown show">
                                    <ul class="nav nav-sm flex-column">
                                        <li class="nav-item">
                                            <b-link aria-controls="sidebarAdvanceUI" aria-expanded="false"
                                                    class="nav-link menu-link"
                                                    data-bs-toggle="collapse" href="#sidebarAdvanceUI"
                                                    role="button">
                                                <i class="ri-stack-line"></i>
                                                <span data-key="t-advance-ui">{{
                                                        $t("t-advance-ui")
                                                    }}</span>
                                                <b-badge class="badge-pill bg-success" data-key="t-new"
                                                         variant="success">{{
                                                        $t("t-new")
                                                    }}
                                                </b-badge>
                                        ...
                                        <li class="nav-item">
                                            <b-link aria-controls="sidebarForms" aria-expanded="false"
                                                    class="nav-link menu-link" data-bs-toggle="collapse"
                                            ...
                                            <div id="sidebarForms" class="collapse menu-dropdown">
                                                <ul class="nav nav-sm flex-column">
                                                    ...
                                                    <li class="nav-item">
                                                        <router-link class="nav-link" data-key="t-pickers"
                                                                     to="/form/pickers">
                                                            {{ $t("t-pickers") }}
                                                        </router-link>
                                                    </li>
                                                    <li class="nav-item">
                                                        <router-link class="nav-link" data-key="t-input-masks"
                                                                     to="/form/masks">
                                                            {{ $t("t-input-masks") }}
                                                        </router-link>
                                                    </li>
                                                    <li class="nav-item">
                                                        <router-link class="nav-link" data-key="t-advanced"
                                                                     to="/form/advanced">
                                                            {{ $t("t-advanced") }}
                                                        </router-link>
                                                    </li>
                                                    ...
                                                    <li class="nav-item">
                                                        <router-link class="nav-link" data-key="t-wizard"
                                                                     to="/form/wizard">{{ $t("t-wizard") }}
                                                        </router-link>
                                                    </li>
                                                    <li class="nav-item">
                                                        <router-link class="nav-link" data-key="t-editors"
                                                                     to="/form/editors">{{ $t("t-editors") }}
                                                        </router-link>
                                                    </li>
                                                    <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                            <b-link aria-controls="sidebarTables" aria-expanded="false"
                                                    class="nav-link menu-link" data-bs-toggle="collapse"
                                            ...
                                            <div id="sidebarTables" class="collapse menu-dropdown">
                                                <ul class="nav nav-sm flex-column">
                                                    ...
                                                    <li class="nav-item">
                                                        <router-link class="nav-link" data-key="t-grid-js"
                                                                     to="/tables/gridjs">{{ $t("t-grid-js") }}
                                                        </router-link>
                                                    </li>
                                                </ul>
                                            </div>
                                        ...
                                        <li class="nav-item">
                                            <b-link aria-controls="sidebarCharts" aria-expanded="false"
                                                    class="nav-link menu-link" data-bs-toggle="collapse"
                                            ...
                                            <div id="sidebarCharts" class="collapse menu-dropdown">
                                                <ul class="nav nav-sm flex-column">
                                                    <li class="nav-item">
                                                        ...
                                                        <div id="sidebarApexcharts" class="collapse menu-dropdown">
                                                            <ul class="nav nav-sm flex-column">
                                                                ...
                                                                <li class="nav-item">
                                                                    <router-link class="nav-link"
                                                                                 data-key="t-column" to="/charts/apex-column">
                                                                        {{ $t("t-column") }}
                                                                    </router-link>
                                                                </li>
                                                                <li class="nav-item">
                                                                ...
                                                                <li class="nav-item">
                                                                    <router-link class="nav-link"
                                                                                 data-key="t-mixed" to="/charts/apex-mixed">
                                                                        {{ $t("t-mixed") }}
                                                                    </router-link>
                                                                </li>
                                                                ...
                                                                <li class="nav-item">
                                                                    <router-link class="nav-link"
                                                                                 data-key="t-boxplot" to="/charts/apex-boxplot">
                                                                        {{ $t("t-boxplot") }}
                                                                    </router-link>
                                                                </li>
                                                                <li class="nav-item">
                                                                    <router-link class="nav-link"
                                                                                 data-key="t-bubble" to="/charts/apex-bubble">
                                                                        {{ $t("t-bubble") }}
                                                                    </router-link>
                                                                </li>
                                                                <li class="nav-item">
                                                                    <router-link class="nav-link"
                                                                                 data-key="t-scatter" to="/charts/apex-scatter">
                                                                        {{ $t("t-scatter") }}
                                                                    </router-link>
                                                                </li>
                                                                <li class="nav-item">
                                                                    <router-link class="nav-link"
                                                                                 data-key="t-heatmap" to="/charts/apex-heatmap">
                                                                        {{ $t("t-heatmap") }}
                                                                    </router-link>
                                                                </li>
                                                                <li class="nav-item">
                                                                    <router-link class="nav-link"
                                                                                 data-key="t-treemap" to="/charts/apex-treemap">
                                                                        {{ $t("t-treemap") }}
                                                                    </router-link>
                                                                </li>
                                                                <li class="nav-item">
                                                                ...
                                                                <li class="nav-item">
                                                                    <router-link class="nav-link"
                                                                                 data-key="t-radar" to="/charts/apex-radar">
                                                                        {{ $t("t-radar") }}
                                                                    </router-link>
                                                                </li>
                                                                <li class="nav-item">
                                                    ...
                                                    <li class="nav-item">
                                                        <router-link class="nav-link" data-key="t-chartjs"
                                                                     to="/charts/chartjs">
                                                            {{ $t("t-chartjs") }}
                                                        </router-link>
                                                    </li>
                                                    <li class="nav-item">
                                                        <router-link class="nav-link" data-key="t-echarts"
                                                                     to="/charts/echart">{{ $t("t-echarts") }}
                                                        </router-link>
                                                    </li>
                                                </ul>
                                            </div>
                                        ...
                                        <li class="nav-item">
                                            <b-link aria-controls="sidebarIcons" aria-expanded="false"
                                                    class="nav-link menu-link" data-bs-toggle="collapse"
                                            ...
                                            <div id="sidebarIcons" class="collapse menu-dropdown">
                                                <ul class="nav nav-sm flex-column">
                                                    <li class="nav-item">
                                                        <router-link class="nav-link" data-key="t-remix"
                                                                     to="/icons/remix">{{ $t("t-remix") }}
                                                        </router-link>
                                                    </li>
                                                    <li class="nav-item">
                                                    ...
                                                    <li class="nav-item">
                                                        <router-link class="nav-link" data-key="t-feather"
                                                                     to="/icons/feather">{{ $t("t-feather") }}
                                                        </router-link>
                                                    </li>
                                                    <li class="nav-item">
                                                        <router-link class="nav-link" data-key="t-feather"
                                        ...
                                        <li class="nav-item">
                                            <b-link aria-controls="sidebarMaps" aria-expanded="false"
                                                    class="nav-link menu-link" data-bs-toggle="collapse"
                                            ...
                                            <div id="sidebarMaps" class="collapse menu-dropdown">
                                                <ul class="nav nav-sm flex-column">
                                                    <li class="nav-item">
                                                        <router-link class="nav-link" data-key="t-google"
                                                                     to="/maps/google">
                                                            {{ $t("t-google") }}
                                                        </router-link>
                                                    </li>
                                                    <li class="nav-item">
                                                        <router-link class="nav-link" data-key="t-leaflet"
                                                                     to="/maps/leaflet">
                                                            {{ $t("t-leaflet") }}
                                                        </router-link>
                                                    </li>
                                        ...
                                        <li class="nav-item">
                                            <b-link aria-controls="sidebarMultilevel" aria-expanded="false"
                                                    class="nav-link menu-link"
                                                    data-bs-toggle="collapse" href="#sidebarMultilevel"
                                                    role="button">
                                                ...
                                                <ul class="nav nav-sm flex-column">
                                                    ...
                                                    <li class="nav-item">
                                                        ...
                                                        <div id="sidebarAccount" class="collapse menu-dropdown">
                                                            <ul class="nav nav-sm flex-column">
                                                                <li class="nav-item">
                                                                    <b-link class="nav-link" data-key="t-level-2.1"
                                                                            href="#">
                                                                        {{ $t("t-level-2.1") }}
                                                                    </b-link>
                                                                </li>
