...
<template>
    <div>
        ...
        <div class="customizer-setting d-none d-md-block">
            <div id="mdi-cog" aria-controls="theme-settings-offcanvas"
                 class="btn-info btn-rounded shadow-lg btn btn-icon btn-lg p-2" data-bs-target="#theme-settings-offcanvas" data-bs-toggle="offcanvas">
                <i class="mdi mdi-spin mdi-cog-outline fs-22"></i>
            </div>
        </div>
        <div id="theme-settings-offcanvas" class="offcanvas offcanvas-end border-0" tabindex="-1">
            <div class="d-flex align-items-center bg-primary bg-gradient p-3 offcanvas-header">
                <h5 class="m-0 me-2 text-white">Theme Customizer</h5>
                <b-button aria-label="Close" class="btn-close btn-close-white ms-auto" data-bs-dismiss="offcanvas"
                          type="button"
                ...
                <SimpleBar class="h-100">
                        ...
                        <b-row>
                            <b-col cols="4">
                                <div class="form-check card-radio">
                                    <input id="customizer-layout01" v-model="layoutType" class="form-check-input" name="data-layout"
                      ...
                      <span class="flex-grow-1">
                        <span class="d-flex h-100 flex-column">
                          ...
                          <span class="bg-light d-block p-1 mt-auto"></span>
                            ...
                            <b-col cols="4">
                                <div class="form-check card-radio">
                                    <input id="customizer-layout02" v-model="layoutType" class="form-check-input" name="data-layout"
                    ...
                    <span class="d-flex h-100 flex-column gap-1">
                      ...
                      <span class="bg-light d-block p-1 mt-auto"></span>
                            ...
                            <b-col cols="4">
                                <div class="form-check card-radio">
                                    <input id="customizer-layout03" v-model="layoutType" class="form-check-input" name="data-layout"
                      ...
                      <span class="flex-grow-1">
                        ...
                        <div class="colorscheme-cardradio">
                            <b-row>
                                <b-col cols="4">
                                    <div class="form-check card-radio">
                                        <input id="layout-mode-light" v-model="mode" class="form-check-input"
                            ...
                            <span class="bg-light d-block p-1 mt-auto"></span>
                                ...
                                <b-col cols="4">
                                    <div class="form-check card-radio dark">
                                        <input id="layout-mode-dark" v-model="mode" class="form-check-input"
                                               name="data-layout-mode"
                      ...
                      <span class="d-flex gap-1 h-100">
                        ...
                        <div v-if="layoutType != 'twocolumn'" id="layout-width">
                            ...
                            <b-row>
                                <b-col cols="4">
                                    <div class="form-check card-radio">
                                        <input id="layout-width-fluid" v-model="layoutWidth" class="form-check-input"
                        ...
                        <span class="flex-grow-1">
                          <span class="d-flex h-100 flex-column">
                            ...
                            <span class="bg-light d-block p-1 mt-auto"></span>
                                ...
                                <b-col cols="4">
                                    <div class="form-check card-radio">
                                        <input id="layout-width-boxed" v-model="layoutWidth" class="form-check-input"
                                               name="data-layout-width"
                      ...
                      <span class="d-flex gap-1 h-100 border-start border-end">
                        ...
                        <div v-if="layoutType != 'twocolumn'" id="layout-position">
                            ...
                            <div class="btn-group radio" role="group">
                                <input id="layout-position-fixed" v-model="position" class="btn-check"
                                       name="data-layout-position"
                                       type="radio" value="fixed"/>
                                <label class="btn btn-light w-sm" for="layout-position-fixed">Fixed</label>

                                <input id="layout-position-scrollable" v-model="position" class="btn-check"
                                       name="data-layout-position"
                        ...
                        <b-row>
                            <b-col cols="4">
                                <div class="form-check card-radio">
                                    <input id="topbar-color-light" v-model="topbar" class="form-check-input"
                                           name="data-topbar" type="radio"
                                           value="light"/>
                      ...
                      <span class="flex-grow-1">
                        <span class="d-flex h-100 flex-column">
                          ...
                          <span class="bg-light d-block p-1 mt-auto"></span>
                            ...
                            <b-col cols="4">
                                <div class="form-check card-radio">
                                    <input id="topbar-color-dark" v-model="topbar" class="form-check-input"
                                           name="data-topbar" type="radio"
                                           value="dark"/>
                            ...
                            <b-row>
                                <b-col cols="4">
                                    <div class="form-check sidebar-setting card-radio">
                                        <input id="sidebar-size-default" v-model="sidebarSize" class="form-check-input"
                        ...
                        <span class="flex-grow-1">
                          <span class="d-flex h-100 flex-column">
                            ...
                            <span class="bg-light d-block p-1 mt-auto"></span>
                                ...
                                <b-col cols="4">
                                    <div class="form-check sidebar-setting card-radio">
                                        <input id="sidebar-size-compact" v-model="sidebarSize" class="form-check-input"
                                               name="data-sidebar-size"
                                               type="radio" value="md"/>
                        ...
                        <span class="flex-grow-1">
                          <span class="d-flex h-100 flex-column">
                            ...
                            <span class="bg-light d-block p-1 mt-auto"></span>
                                ...
                                <b-col cols="4">
                                    <div class="form-check sidebar-setting card-radio">
                                        <input id="sidebar-size-small" v-model="sidebarSize" class="form-check-input"
                                               name="data-sidebar-size"
                                               type="radio" value="sm"/>
                        ...
                        <span class="flex-grow-1">
                          <span class="d-flex h-100 flex-column">
                            ...
                            <span class="bg-light d-block p-1 mt-auto"></span>
                                ...
                                <b-col cols="4">
                                    <div class="form-check sidebar-setting card-radio">
                                        <input id="sidebar-size-small-hover" v-model="sidebarSize" class="form-check-input"
                                               name="data-sidebar-size"
                      ...
                      <span class="d-flex gap-1 h-100">
                        ...
                        <div v-if="layoutType == 'vertical'" id="sidebar-view">
                            ...
                            <b-row>
                                <b-col cols="4">
                                    <div class="form-check sidebar-setting card-radio">
                                        <input id="sidebar-view-default" v-model="sidebarView" class="form-check-input"
                        ...
                        <span class="flex-grow-1">
                          <span class="d-flex h-100 flex-column">
                            ...
                            <span class="bg-light d-block p-1 mt-auto"></span>
                                ...
                                <b-col cols="4">
                                    <div class="form-check sidebar-setting card-radio">
                                        <input id="sidebar-view-detached" v-model="sidebarView" class="form-check-input"
                                               name="data-layout-style"
                                               type="radio" value="detached"/>
                      ...
                      <span class="d-flex h-100 flex-column">
                        ...
                        <div v-if="layoutType != 'horizontal'" id="sidebar-color">
                            ...
                            <b-row>
                                <b-col cols="4">
                                    <div class="form-check sidebar-setting card-radio">
                                        <input id="sidebar-color-light" v-model="sidebarColor" class="form-check-input"
                                               name="data-sidebar"
                                               type="radio" value="light"/>
                        ...
                        <span class="flex-grow-1">
                          <span class="d-flex h-100 flex-column">
                            ...
                            <span class="bg-light d-block p-1 mt-auto"></span>
                                ...
                                <b-col cols="4">
                                    <div class="form-check sidebar-setting card-radio">
                                        <input id="sidebar-color-dark" v-model="sidebarColor" class="form-check-input"
                                               name="data-sidebar"
                                               type="radio" value="dark"/>
                        ...
                        <span class="flex-grow-1">
                          <span class="d-flex h-100 flex-column">
                            ...
                            <span class="bg-light d-block p-1 mt-auto"></span>
                                ...
                                <b-col cols="4">
                                    <button v-b-toggle.collapseBgGradient
                      ...
                      <span class="flex-grow-1">
                          ...
                          <span class="bg-light d-block p-1 mt-auto"></span>
                            ...
                            <b-collapse id="collapseBgGradient">
                                <div class="d-flex gap-2 flex-wrap img-switch p-2 px-3 bg-light rounded">
                                    ...
                                    <div class="form-check sidebar-setting card-radio">
                                        <input id="sidebar-color-gradient" v-model="sidebarColor" class="form-check-input"
                                               name="data-sidebar"
                                    ...
                                    <div class="form-check sidebar-setting card-radio">
                                        <input id="sidebar-color-gradient-2" v-model="sidebarColor" class="form-check-input"
                                               name="data-sidebar"
                                               type="radio" value="gradient-2">
                                        <label class="form-check-label p-0 avatar-xs rounded-circle"
                                    ...
                                    <div class="form-check sidebar-setting card-radio">
                                        <input id="sidebar-color-gradient-3" v-model="sidebarColor" class="form-check-input"
                                               name="data-sidebar"
                                               type="radio" value="gradient-3">
                                        <label class="form-check-label p-0 avatar-xs rounded-circle"
                                    ...
                                    <div class="form-check sidebar-setting card-radio">
                                        <input id="sidebar-color-gradient-4" v-model="sidebarColor" class="form-check-input"
                                               name="data-sidebar"
                                               type="radio" value="gradient-4">
                                        <label class="form-check-label p-0 avatar-xs rounded-circle"
                        ...
                        <div v-if="layoutType != 'horizontal'" id="sidebar-img">
                            ...
                            <div class="d-flex gap-2 flex-wrap img-switch">
                                <div class="form-check sidebar-setting card-radio">
                                    <input id="sidebarimg-none" v-model="sidebarImage" class="form-check-input"
                    ...
                    <span class="avatar-md w-auto bg-light d-flex align-items-center justify-content-center">
                      <i class="ri-close-fill fs-20"></i>
                                ...
                                <div class="form-check sidebar-setting card-radio">
                                    <input id="sidebarimg-01" v-model="sidebarImage" class="form-check-input"
                                           name="data-sidebar-img"
                                           type="radio" value="img-1"/>
                                    <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-01">
                                        <img alt="" class="avatar-md w-auto object-cover"
                                             src="@/assets/images/sidebar/img-1.jpg">
                                    </label>
                                </div>

                                <div class="form-check sidebar-setting card-radio">
                                    <input id="sidebarimg-02" v-model="sidebarImage" class="form-check-input"
                                           name="data-sidebar-img"
                                           type="radio" value="img-2"/>
                                ...
                                <div class="form-check sidebar-setting card-radio">
                                    <input id="sidebarimg-03" v-model="sidebarImage" class="form-check-input"
                                           name="data-sidebar-img"
                                           type="radio" value="img-3"/>
                                ...
                                <div class="form-check sidebar-setting card-radio">
                                    <input id="sidebarimg-04" v-model="sidebarImage" class="form-check-input"
                                           name="data-sidebar-img"
                                           type="radio" value="img-4"/>
                        ...
                        <div id="preloader-menu">
                            ...
                            <b-row>
                                <b-col cols="4">
                                    <div class="form-check sidebar-setting card-radio">
                                        <input id="preloader-view-custom" v-model="preloader" class="form-check-input"
                                               name="data-preloader"
                                               type="radio" value="enable">
                        ...
                        <span class="flex-grow-1">
                          <span class="d-flex h-100 flex-column">
                            ...
                            <span class="bg-light d-block p-1 mt-auto"></span>
                                ...
                                <b-col cols="4">
                                    <div class="form-check sidebar-setting card-radio">
                                        <input id="preloader-view-none" v-model="preloader" class="form-check-input"
                                               name="data-preloader"
                                               type="radio" value="disable">
            ...
            <div class="offcanvas-footer border-top p-3 text-center">
                <b-row>
                    <b-col cols="6">
                        <b-button id="reset-layout" class="w-100" type="button" variant="light"> Reset</b-button>
                    </b-col>
                    <b-col cols="6">
                        <b-button class="w-100" type="button" variant="primary"> Preview</b-button>
                    </b-col>
                </b-row>
            </div>
        </div>
