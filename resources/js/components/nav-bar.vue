            ...
            <div class="navbar-header">
              ...
              <span class="logo-sm">
                ...
                <img alt="" height="17" src="@/assets/images/logo-light.png"/>
                    ...
                    <button id="topnav-hamburger-icon" class="
              btn btn-sm
              px-3
              fs-16
              header-item
              ...
              <span></span>
                    ...
                    <form class="app-search d-none d-md-block">
                        <div class="position-relative">
                            <input id="search-options" autocomplete="off" class="form-control" placeholder="Search..."
                                   type="text"
                                   value=""/>
                            <span class="mdi mdi-magnify search-widget-icon"></span>
                            <span id="search-close-options" class="
                  mdi mdi-close-circle
                  search-widget-icon search-widget-icon-close
                  d-none
                "></span>
                        </div>
                        <div id="search-dropdown" class="dropdown-menu dropdown-menu-lg">
                            <SimpleBar data-simplebar style="max-height: 320px">
                                ...
                                <div class="dropdown-item bg-transparent text-wrap">
                                    <router-link class="btn btn-soft-secondary btn-sm btn-rounded" to="/">how to setup
                                        <i
                                            class="mdi mdi-magnify ms-1"></i></router-link>
                                    <router-link class="btn btn-soft-secondary btn-sm btn-rounded" to="/">buttons <i
                                        class="mdi mdi-magnify ms-1"></i></router-link>
                                </div>
                                ...
                                <b-link class="dropdown-item notify-item" href="javascript:void(0);">
                                    <i class="
                    ...
                    "></i>
                                ...
                                <div class="notification-list">
                                    <b-link class="d-flex dropdown-item notify-item py-2" href="javascript:void(0);">
                                        <img alt="user-pic"
                            ...
                            <div class="text-center pt-3 pb-1">
                                <router-link class="btn btn-primary btn-sm" to="/pages/search-results">View All Results
                                    <i
                ...
                <div class="d-flex align-items-center">
                    <div class="dropdown d-md-none topbar-head-dropdown header-item">
                        <button id="page-header-search-dropdown" aria-expanded="false"
                                aria-haspopup="true" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle" data-bs-toggle="dropdown"
                                type="button">
                            ...
                            <form class="p-3">
                                <div class="form-group m-0">
                                    <div class="input-group">
                                        <input aria-label="Recipient's username" class="form-control" placeholder="Search ..."
                                               type="text"/>
                    ...
                    <div class="dropdown ms-1 topbar-head-dropdown header-item">
                        <button aria-expanded="false" aria-haspopup="true"
                                class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle" data-bs-toggle="dropdown" type="button">
                            <img id="header-lang-img" alt="Header Language" class="rounded"
                                 height="20"
                                 src="@/assets/images/flags/us.svg"/>
                        </button>
                        <div class="dropdown-menu dropdown-menu-end">
                            <b-link v-for="(entry, i) in languages" :key="`Lang${i}`" :class="{ active: lan === entry.language }"
                                    :value="entry"
                                    class="dropdown-item notify-item language py-2"
                                    data-lang="en"
                                    href="javascript:void(0);"
                                    title="English" @click="setLanguage(entry.language, entry.title, entry.flag)">
                ...
                ">
                                <b-row class="align-items-center">
                                    ...
                                    <b-col cols="auto">
                                        <b-link class="btn btn-sm btn-soft-info" href="#!">
                                            View All Apps
                    ...
                    <div class="dropdown topbar-head-dropdown ms-1 header-item">
                        <button id="page-header-cart-dropdown" aria-expanded="false"
                                aria-haspopup="true" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle" data-bs-auto-close="outside"
                        ...
                        <div aria-labelledby="page-header-cart-dropdown"
                            ...
                            <div class="p-3 border-top-0 border-start-0 border-end-0 border-dashed border">
                                <b-row class="align-items-center">
                                    ...
                                    <b-col cols="auto">
                                        <b-badge class="badge-soft-warning fs-13" variant="soft-warning"><span
                            ...
                            <SimpleBar data-simplebar style="max-height: 300px">
                                <div class="p-2">
                                    <div id="empty-cart" class="text-center empty-cart">
                                        ...
                                        <b-link class="btn btn-success w-md mb-3" href="/ecommerce/products">Shop Now
                                        </b-link>
                                    </div>
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-1">
                                                <h6 class="mt-0 mb-1 fs-14">
                                                    <b-link class="text-reset" href="/ecommerce/product-details">Branded
                                                        T-Shirts
                                                    </b-link>
                                                </h6>
                                            ...
                                            <div class="ps-2">
                                                <b-button class="btn btn-icon remove-item-btn" size="sm" type="button"
                                                          variant="ghost-secondary"><i
                                                    class="ri-close-fill fs-16"></i></b-button>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-1">
                                                <h6 class="mt-0 mb-1 fs-14">
                                                    <b-link class="text-reset" href="/ecommerce/product-details">
                                                        Bentwood Chair
                                                    </b-link>
                                                </h6>
                                                <p class="mb-0 fs-12 text-muted">
                                    ...
                                    <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-1">
                                                <h6 class="mt-0 mb-1 fs-14">
                                                    <b-link class="text-reset" href="/ecommerce/product-details">Gray
                                                        Styled T-Shirt
                                                    </b-link>
                                                </h6>
                                                <p class="mb-0 fs-12 text-muted">
                            ...
                            <div id="checkout-elem"
                                 class="p-3 border-bottom-0 border-start-0 border-end-0 border-dashed border">
                                <div class="d-flex justify-content-between align-items-center pb-3">
                                    <h5 class="m-0 text-muted">Total:</h5>
                                    <div class="px-2">
                                        <h5 id="cart-item-total" class="m-0">$1258.58</h5>
                                    </div>
                                </div>

                                <b-link class="btn btn-success text-center w-100" href="/ecommerce/checkout">
                                    Checkout
                                </b-link>
                            </div>
                        </div>
                    ...
                    <div class="ms-1 header-item d-none d-sm-flex">
                        <b-button class="btn-icon btn-topbar rounded-circle" data-toggle="fullscreen" type="button"
                                  variant="ghost-secondary" @click="initFullScreen">
                            <i class="bx bx-fullscreen fs-22"></i>
                        </b-button>
                    </div>

                    <div class="ms-1 header-item d-none d-sm-flex">
                        <b-button class="btn-icon btn-topbar rounded-circle light-dark-mode" type="button"
                    ...
                    <div class="dropdown topbar-head-dropdown ms-1 header-item">
                        <button id="page-header-notifications-dropdown" aria-expanded="false"
                                aria-haspopup="true" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle" data-bs-toggle="dropdown"
                                type="button">
                ...
                3<span class="visually-hidden">unread messages</span></span>
                        ...
                        <div aria-labelledby="page-header-notifications-dropdown"
                            ...
                            <div class="dropdown-head bg-primary bg-pattern rounded-top">
                                <div class="p-3">
                                    <b-row class="align-items-center">
                                        ...
                                        <b-col class="dropdown-tabs" cols="auto">
                                            <b-badge class="badge-soft-light fs-13" variant="soft-light"> 4 New
                                            </b-badge>
                                        </b-col>
                                    </b-row>
                                </div>
                                ...
                                <div class="px-2 pt-2">
                                    <ul id="notificationItemsTab" class="nav nav-tabs dropdown-tabs nav-tabs-custom"
                                        data-dropdown-tabs="true" role="tablist">
                                        <li class="nav-item">
                                            <b-link aria-selected="false" class="nav-link active" data-bs-toggle="tab"
                                                    href="#all-noti-tab"
                                                    role="tab" @click.capture.stop>
                                                All (4)
                                            </b-link>
                                        </li>
                                        <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                            <b-link aria-selected="false" class="nav-link" data-bs-toggle="tab" href="#alerts-tab"
                                                    role="tab"
                                                    @click.capture.stop>
                                                Alerts
                                            </b-link>
                            ...
                            <div id="notificationItemsTabContent" class="tab-content">
                                ...
                                <div id="all-noti-tab" class="tab-pane fade py-2 ps-2 show active" role="tabpanel">
                                    <SimpleBar class="pe-2" data-simplebar style="max-height: 300px">
                                        <div
                          ...
                          <span class="avatar-title bg-soft-danger text-danger rounded-circle fs-16">
                            ...
                            <span><i class="mdi mdi-clock-outline"></i> 4 hrs
                              ago</span>
                                ...
                                <div id="messages-tab" aria-labelledby="messages-tab" class="tab-pane fade py-2 ps-2"
                                     role="tabpanel">
                                    <SimpleBar class="pe-2" data-simplebar style="max-height: 300px">
                            ...
                            <span><i class="mdi mdi-clock-outline"></i> 3 days
                              ago</span>
                                ...
                                <div id="alerts-tab" aria-labelledby="alerts-tab" class="tab-pane fade p-4"
                                     role="tabpanel">
                                    <div class="w-25 w-sm-50 pt-3 mx-auto">
                                        <img alt="user-pic" class="img-fluid" src="@/assets/images/svg/bell.svg"/>
                                    </div>
                    ...
                    <div class="dropdown ms-sm-3 header-item topbar-user">
                        <button id="page-header-user-dropdown" aria-expanded="false" aria-haspopup="true" class="btn"
                  ...
                  <span class="d-none d-xl-block ms-1 fs-12 text-muted user-name-sub-text">Founder</span>
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <router-link class="dropdown-item" to="/pages/profile-setting">
                                <b-badge class="bg-soft-success text-success mt-1 float-end"
                                         variant="soft-success">New
                                </b-badge>
                                <i
