            ...
            <b-col cols="12">
                <b-card no-body>
                    <b-card-body>
                        ...
                        <p class="card-title-desc mb-2">
                            Use
                            <code>&lt;i class="mdi mdi-*-*"&gt;&lt;/i&gt;</code> class.
                            <b-badge variant="success">v 6.5.95</b-badge>
                            .
                        </p>

                        <b-row id="newIcons" class="icon-demo-content"></b-row>
                    </b-card-body>
                </b-card>
                ...
                <b-card no-body>
                    <b-card-body>
                        ...
                        <b-row id="icons" class="icon-demo-content"></b-row>
                    </b-card-body>
                </b-card>
            </b-col>
        </b-row>
