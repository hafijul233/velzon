            ...
            <b-col xxl="6">
                <b-card no-body>
                    <b-card-header class="align-items-center d-flex">
                        <b-card-title class="mb-0 flex-grow-1">Default Accordion</b-card-title>
                        <div class="flex-shrink-0">
                            <div class="form-check form-switch form-switch-right form-switch-md">
                                <label class="form-label text-muted" for="default-base-showcode">Show Code</label>
                                <input id="default-base-showcode" class="form-check-input code-switcher"
                                       type="checkbox"/>
                            </div>
                        </div>
                    </b-card-header>
...
&lt;/b-accordion&gt;
            ...
            <b-col xxl="6">
                <b-card no-body>
                    <b-card-header class="align-items-center d-flex">
                        <b-card-title class="mb-0 flex-grow-1">Accordion Flush</b-card-title>
                        <div class="flex-shrink-0">
                            <div class="form-check form-switch form-switch-right form-switch-md">
                                <label class="form-label text-muted" for="accordion-flush">Show Code</label>
                                <input id="accordion-flush" class="form-check-input code-switcher" type="checkbox"/>
                            </div>
                        </div>
                    </b-card-header>
                    <b-card-body>
...
&lt;b-accordion&gt;</code></pre>
        ...
        <b-row>
            <b-col xxl="6">
                <b-card no-body>
                    <b-card-header class="align-items-center d-flex">
                        <b-card-title class="mb-0 flex-grow-1">Accordions with Icons</b-card-title>
                        <div class="flex-shrink-0">
                            <div class="form-check form-switch form-switch-right form-switch-md">
                                <label class="form-label text-muted" for="accordion-icon">Show Code</label>
                                <input id="accordion-icon" class="form-check-input code-switcher" type="checkbox"/>
                            </div>
                        </div>
                    </b-card-header>
                    <b-card-body>
                        ...
                        <div class="live-preview">
                            <div id="accordionWithicon" class="accordion custom-accordionwithicon accordion-secondary">
                                <div class="accordion-item">
                                    <h2 id="accordionwithiconExample1" class="accordion-header">
                                        <button aria-controls="accor_iconExamplecollapse1" aria-expanded="true"
                                                class="accordion-button"
                                                data-bs-target="#accor_iconExamplecollapse1" data-bs-toggle="collapse"
                                                type="button">
                                            <i class="ri-global-line me-2"></i> How Does Age
                                            Verification Work?
                                        </button>
                                    </h2>
                                    <div id="accor_iconExamplecollapse1" aria-labelledby="accordionwithiconExample1"
                                ...
                                <div class="accordion-item">
                                    <h2 id="accordionwithiconExample2" class="accordion-header">
                                        <button aria-controls="accor_iconExamplecollapse2" aria-expanded="false"
                                                class="accordion-button collapsed"
                                                data-bs-target="#accor_iconExamplecollapse2" data-bs-toggle="collapse"
                                                type="button">
                                            <i class="ri-user-location-line me-2"></i> How Does Link
                                            Tracking Work?
                                        </button>
                                    </h2>
                                    <div id="accor_iconExamplecollapse2" aria-labelledby="accordionwithiconExample2"
                                ...
                                <div class="accordion-item">
                                    <h2 id="accordionwithiconExample3" class="accordion-header">
                                        <button aria-controls="accor_iconExamplecollapse3" aria-expanded="false"
                                                class="accordion-button collapsed"
                                                data-bs-target="#accor_iconExamplecollapse3" data-bs-toggle="collapse"
                                                type="button">
                                            <i class="ri-pen-nib-line me-2"></i> How Do I Set Up the
                                            Drip Feature?
                                        </button>
                                    </h2>
                                    <div id="accor_iconExamplecollapse3" aria-labelledby="accordionwithiconExample3"
                                         class="accordion-collapse collapse"
                                         data-bs-parent="#accordionWithicon">
                                        <div class="accordion-body">
...
&lt;/b-accordion&gt;</code></pre>
            ...
            <b-col xxl="6">
                <b-card no-body>
                    <b-card-header class="align-items-center d-flex">
                        <b-card-title class="mb-0 flex-grow-1"> Accordions without Icons</b-card-title>
                        <div class="flex-shrink-0">
                            <div class="form-check form-switch form-switch-right form-switch-md">
                                <label class="form-label text-muted" for="accordion-without-icon-showcode">Show
                                    Code</label>
                                <input id="accordion-without-icon-showcode" class="form-check-input code-switcher"
                                       type="checkbox"/>
                            </div>
                        </div>
                    </b-card-header>
                    <b-card-body>
                        ...
                        <div class="live-preview">
                            <div id="accordionWithouticon" class="accordion accordion-icon-none">
                                <div class="accordion-item">
                                    <h2 id="accordionwithouticonExample1" class="accordion-header">
                                        <button aria-controls="accor_withouticoncollapse1" aria-expanded="true"
                                                class="accordion-button"
                                                data-bs-target="#accor_withouticoncollapse1" data-bs-toggle="collapse"
                                                type="button">
                                            <i class="ri-global-line me-2"></i> How Does Age
                                            Verification Work?
                                        </button>
                                    </h2>
                                    <div id="accor_withouticoncollapse1" aria-labelledby="accordionwithouticonExample1"
                                         class="accordion-collapse collapse show"
                                ...
                                <div class="accordion-item">
                                    <h2 id="accordionwithouticonExample2" class="accordion-header">
                                        <button aria-controls="accor_withouticoncollapse2" aria-expanded="false"
                                                class="accordion-button collapsed"
                                                data-bs-target="#accor_withouticoncollapse2" data-bs-toggle="collapse"
                                                type="button">
                                            <i class="ri-user-location-line me-2"></i> How Does Link
                                            Tracking Work?
                                        </button>
                                    </h2>
                                    <div id="accor_withouticoncollapse2" aria-labelledby="accordionwithouticonExample2"
                                         class="accordion-collapse collapse"
                                         data-bs-parent="#accordionWithouticon">
                                        <div class="accordion-body">
                                ...
                                <div class="accordion-item">
                                    <h2 id="accordionwithouticonExample3" class="accordion-header">
                                        <button aria-controls="accor_withouticoncollapse3" aria-expanded="false"
                                                class="accordion-button collapsed"
                                                data-bs-target="#accor_withouticoncollapse3" data-bs-toggle="collapse"
                                                type="button">
                                            <i class="ri-pen-nib-line me-2"></i> How Do I Set Up the
                                            Drip Feature?
                                        </button>
                                    </h2>
                                    <div id="accor_withouticoncollapse3" aria-labelledby="accordionwithouticonExample3"
                                         class="accordion-collapse collapse"
                                         data-bs-parent="#accordionWithouticon">
                                        <div class="accordion-body">
                                            Cras ultricies mi eu turpis hendrerit fringilla.
...
&lt;/b-accordion&gt;</code></pre>
            ...
            <b-col xl="12">
                <b-card no-body>
                    <b-card-header class="align-items-center d-flex">
                        <b-card-title class="mb-0 flex-grow-1"> Accordions with Plus Icon</b-card-title>
                        <div class="flex-shrink-0">
                            <div class="form-check form-switch form-switch-right form-switch-md">
                                <label class="form-label text-muted" for="withplusiconaccordion-showcode">Show
                                    Code</label>
                                <input id="withplusiconaccordion-showcode" class="form-check-input code-switcher"
                                       type="checkbox"/>
                            </div>
                        </div>
                    </b-card-header>
                    <b-card-body>
                        ...
                        <div class="live-preview">
                            <b-accordion id="accordionWithplusicon" class="custom-accordionwithicon-plus">
...
&lt;/b-accordion&gt;</code></pre>
        ...
        <b-row>
            <b-col xxl="6">
                <b-card no-body>
                    <b-card-header class="align-items-center d-flex">
                        <b-card-title class="mb-0 flex-grow-1">Left Icon Accordions</b-card-title>
                        <div class="flex-shrink-0">
                            <div class="form-check form-switch form-switch-right form-switch-md">
                                <label class="form-label text-muted" for="accordion-lefticon-showcode">Show Code</label>
                                <input id="accordion-lefticon-showcode" class="form-check-input code-switcher"
                                       type="checkbox"/>
                            </div>
                        </div>
                    </b-card-header>
                    <b-card-body>
                        ...
                        <div class="live-preview">
                            <b-accordion id="accordionlefticon" class="
                  lefticon-accordion
...
&lt;/b-accordion&gt;</code></pre>
            ...
            <b-col xxl="6">
                <b-card no-body>
                    <b-card-header class="align-items-center d-flex">
                        <b-card-title class="mb-0 flex-grow-1">Accordions Bordered</b-card-title>
                        <div class="flex-shrink-0">
                            <div class="form-check form-switch form-switch-right form-switch-md">
                                <label class="form-label text-muted" for="accordion-bordered-showcode">Show Code</label>
                                <input id="accordion-bordered-showcode" class="form-check-input code-switcher"
                                       type="checkbox"/>
                            </div>
                        </div>
                    </b-card-header>
                    <b-card-body>
                        ...
                        <div class="live-preview">
                            <b-accordion id="accordionBordered" class="
...
&lt;/b-accordion&gt;</code></pre>
        ...
        <b-row>
            <b-col xl="12">
                <b-card no-body>
                    <b-card-header class="align-items-center d-flex">
                        <b-card-title class="mb-0 flex-grow-1">Nesting Accordions</b-card-title>
                        <div class="flex-shrink-0">
                            <div class="form-check form-switch form-switch-right form-switch-md">
                                <label class="form-label text-muted" for="accordion-nesting-showcode">Show Code</label>
                                <input id="accordion-nesting-showcode" class="form-check-input code-switcher"
                                       type="checkbox"/>
                            </div>
                        </div>
                    </b-card-header>
                    <b-card-body>
                        ...
                        <div class="live-preview">
                            <b-accordion id="accordionnesting" class="custom-accordionwithicon accordion-border-box">
                                <b-accordion-item title="How Do I Add Contacts/Subscribers?" visible>
                                    ...
                                    integration.
                                    <b-accordion id="accordionnesting2" class="
                          nesting2-accordion
                          custom-accordionwithicon
                          accordion-border-box
                          mt-3
                        ">
                                        <b-accordion-item title="How Do I Search For Contacts?" visible>
                                            ...
                                            <b-accordion id="accordionnesting4" class="
                                  nesting4-accordion
                                  custom-accordionwithicon
                                  accordion-border-box
                                  mt-3
                                ">
                                                <b-accordion-item title="How do I reset my digital tide watch ?">
                                        ...
                                        <b-accordion-item title="How Do I Delete a Contact From My List?">
                                ...
                                <b-accordion-item title="How Does Personalization Work?">
                                    ...
                                    fields.
                                    <div id="accordionnesting3" class="
                          accordion
                          nesting3-accordion
                          custom-accordionwithicon
                          accordion-border-box
                        ...
                        ">
                                        <div class="accordion-item mt-2">
                                            <h2 id="accordionnesting3Example2" class="accordion-header">
                                                <button aria-controls="accor_nesting3Examplecollapse2"
                                                        aria-expanded="false"
                                                        class="accordion-button collapsed"
                                ...
                                <b-accordion-item title="What Happens When I Run Out of Messages?">
...
&lt;/b-accordion &gt;</code></pre>
        ...
        <b-row>
            <b-col xl="12">
                <b-card no-body>
                    <b-card-header class="align-items-center d-flex">
                        <b-card-title class="mb-0 flex-grow-1">Accordions Fill Colored</b-card-title>
                        <div class="flex-shrink-0">
                            <div class="form-check form-switch form-switch-right form-switch-md">
                                <label class="form-label text-muted" for="accordion-fill-color-showcode">Show
                                    Code</label>
                                <input id="accordion-fill-color-showcode" class="form-check-input code-switcher"
                                       type="checkbox"/>
                            </div>
                        </div>
                    </b-card-header>
                    <b-card-body>
                        ...
                        <div class="live-preview">
                            <b-row>
                                <b-col xxl="6">
                                    <div id="accordionFill" class="
                      accordion
                      custom-accordionwithicon
                      accordion-fill-success
                    ">
                                        <div class="accordion-item">
                                            <h2 id="accordionFillExample1" class="accordion-header">
                                                <button aria-controls="accor_fill1" aria-expanded="true"
                                                        class="accordion-button"
                                                        data-bs-target="#accor_fill1" data-bs-toggle="collapse"
                                                        type="button">
                                                    What are webhooks?
                                                </button>
                                            </h2>
                                            <div id="accor_fill1" aria-labelledby="accordionFillExample1"
                                                 class="accordion-collapse collapse show"
                                        ...
                                        <div class="accordion-item">
                                            <h2 id="accordionFillExample2" class="accordion-header">
                                                <button aria-controls="accor_fill2" aria-expanded="false"
                                                        class="accordion-button collapsed"
                                                        data-bs-target="#accor_fill2" data-bs-toggle="collapse"
                                                        type="button">
                                                    Where can I find my Textword ID?
                                                </button>
                                            </h2>
                                            <div id="accor_fill2" aria-labelledby="accordionFillExample2"
                                                 class="accordion-collapse collapse"
                                                 data-bs-parent="#accordionFill">
                                                <div class="accordion-body">
                                        ...
                                        <div class="accordion-item">
                                            <h2 id="accordionFillExample3" class="accordion-header">
                                                <button aria-controls="accor_fill3" aria-expanded="false"
                                                        class="accordion-button collapsed"
                                                        data-bs-target="#accor_fill3" data-bs-toggle="collapse"
                                                        type="button">
                                                    Where is your API documentation?
                                                </button>
                                            </h2>
                                            <div id="accor_fill3" aria-labelledby="accordionFillExample3"
                                                 class="accordion-collapse collapse"
                                                 data-bs-parent="#accordionFill">
                                                <div class="accordion-body">
                                ...
                                <b-col xxl="6">
                                    <div id="accordionFill2" class="
                      accordion
                      custom-accordionwithicon
                      accordion-flush accordion-fill-secondary
                    ">
                                        <div class="accordion-item">
                                            <h2 id="accordionFill2Example1" class="accordion-header">
                                                <button aria-controls="accor_fill21" aria-expanded="true"
                                                        class="accordion-button"
                                                        data-bs-target="#accor_fill21" data-bs-toggle="collapse"
                                                        type="button">
                                                    How Does Age Verification Work?
                                                </button>
                                            </h2>
                                            <div id="accor_fill21" aria-labelledby="accordionFill2Example1"
                                                 class="accordion-collapse collapse show"
                                        ...
                                        <div class="accordion-item">
                                            <h2 id="accordionFill2Example2" class="accordion-header">
                                                <button aria-controls="accor_fill22" aria-expanded="false"
                                                        class="accordion-button collapsed"
                                                        data-bs-target="#accor_fill22" data-bs-toggle="collapse"
                                                        type="button">
                                                    What Kind of List Growth Should I Expect?
                                                </button>
                                            </h2>
                                            <div id="accor_fill22" aria-labelledby="accordionFill2Example2"
                                                 class="accordion-collapse collapse"
                                                 data-bs-parent="#accordionFill2">
                                                <div class="accordion-body">
                                        ...
                                        <div class="accordion-item">
                                            <h2 id="accordionFill2Example3" class="accordion-header">
                                                <button aria-controls="accor_fill23" aria-expanded="false"
                                                        class="accordion-button collapsed"
                                                        data-bs-target="#accor_fill23" data-bs-toggle="collapse"
                                                        type="button">
                                                    How Do I Delete a Contact From My List?
                                                </button>
                                            </h2>
                                            <div id="accor_fill23" aria-labelledby="accordionFill2Example3"
                                                 class="accordion-collapse collapse"
                                                 data-bs-parent="#accordionFill2">
                                                <div class="accordion-body">
                                                    Cras ultricies mi eu turpis hendrerit fringilla.
...
&lt;/b-accordion &gt;</code></pre>
        ...
        <b-row>
            <b-col xxl="6">
                <b-card no-body>
                    <b-card-header class="align-items-center d-flex">
                        <b-card-title class="mb-0 flex-grow-1">Collapse Example</b-card-title>
                        <div class="flex-shrink-0">
                            <div class="form-check form-switch form-switch-right form-switch-md">
                                <label class="form-label text-muted" for="collapse-showcode">Show Code</label>
                                <input id="collapse-showcode" class="form-check-input code-switcher" type="checkbox"/>
                            </div>
                        </div>
                    </b-card-header>
                    <b-card-body>
                        ...
                        <div class="live-preview">
                            <div class="hstack gap-2 flex-wrap mb-3">
                                <b-link v-b-toggle.collapse-1 class="btn btn-primary" role="button"> Link with href
                                </b-link>
                                <b-button v-b-toggle.collapse-1 variant="primary">Button with data-bs-target</b-button>
                            </div>
...
&lt;/b-collapse&gt;</code></pre>
            ...
            <b-col xxl="6">
                <b-card no-body>
                    <b-card-header class="align-items-center d-flex">
                        <b-card-title class="mb-0 flex-grow-1">Horizontal Collapse</b-card-title>
                        <div class="flex-shrink-0">
                            <div class="form-check form-switch form-switch-right form-switch-md">
                                <label class="form-label text-muted" for="horizontal-collapse-showcode">Show
                                    Code</label>
                                <input id="horizontal-collapse-showcode" class="form-check-input code-switcher"
                                       type="checkbox"/>
                            </div>
                        </div>
                    </b-card-header>
                    <b-card-body>
                        ...
                        <div class="live-preview">
                            <div class="mb-3">
                                <b-button v-b-toggle.collapse-2 type="button" variant="primary">
                                    Toggle Width Collapse
                                </b-button>
                            </div>
                            <div>
                                <b-collapse id="collapse-2" class="collapse-horizontal" visible>
                                    <b-card class="card-body mb-0" no-body style="width: 300px">
...
&lt;/div&gt;</code></pre>
        ...
        <b-row>
            <b-col xxl="6">
                <b-card no-body>
                    <b-card-header class="align-items-center d-flex">
                        <b-card-title class="mb-0 flex-grow-1">Collapse with Icon</b-card-title>
                        <div class="flex-shrink-0">
                            <div class="form-check form-switch form-switch-right form-switch-md">
                                <label class="form-label text-muted" for="collapse-icon-showcode">Show Code</label>
                                <input id="collapse-icon-showcode" class="form-check-input code-switcher"
                                       type="checkbox"/>
                            </div>
                        </div>
                    </b-card-header>
                    <b-card-body>
                        ...
                        <div class="live-preview">
                            <div class="hstack gap-3 mb-3">
                                <b-link v-b-toggle.collapse-3 class="link-success" role="button">
                                    <i class="ri-arrow-down-circle-line fs-16"></i>
                                </b-link>
                                <b-button v-b-toggle.collapse-4 type="button" variant="light">
                            ...
                            <b-collapse id="collapse-4">
                                <b-card class="mb-0 mt-3" no-body>
                                    <b-card-body>
...
&lt;/B-collapse&gt;</code></pre>
            ...
            <b-col xxl="6">
                <b-card no-body>
                    <b-card-header class="align-items-center d-flex">
                        <b-card-title class="mb-0 flex-grow-1"> Inline & Block Element Collapse</b-card-title>
                        <div class="flex-shrink-0">
                            <div class="form-check form-switch form-switch-right form-switch-md">
                                <label class="form-label text-muted" for="inline-block-collapse-showcode">Show
                                    Code</label>
                                <input id="inline-block-collapse-showcode" class="form-check-input code-switcher"
                                       type="checkbox"/>
                            </div>
                        </div>
                    </b-card-header>
                    <b-card-body>
                        ...
                        <div class="live-preview">
                            <div class="mb-3">
                                <h6 v-b-toggle.collapse-5 class="text-primary">
                                    <code>&lt;h6&gt;</code> Inline Element Collapse
                                </h6>
                                <span v-b-toggle.collapse-6 class="text-primary fw-medium" role="button">
                  <code>&lt;span&gt;</code> Block Element Collapse
                </span>
                            </div>
                            <b-row class="g-2">
                                <b-col cols="auto">
                                    <b-collapse id="collapse-5" class="collapse-horizontal" visible>
                                        <b-card class="card-body mb-0" no-body style="width: 300px">
                                ...
                                <b-col cols="auto">
                                    <b-collapse id="collapse-6" class="collapse-horizontal" visible>
                                        <b-card class="card-body mb-0" no-body style="width: 300px">
...
&lt;/div&gt;</code></pre>
        ...
        <b-row>
            <b-col lg="12">
                <b-card no-body>
                    <b-card-header class="align-items-center d-flex">
                        <b-card-title class="mb-0 flex-grow-1"> Multiple Targets Collapse</b-card-title>
                        <div class="flex-shrink-0">
                            <div class="form-check form-switch form-switch-right form-switch-md">
                                <label class="form-label text-muted" for="multiple-collapse-showcode">Show Code</label>
                                <input id="multiple-collapse-showcode" class="form-check-input code-switcher"
                                       type="checkbox"/>
                            </div>
                        </div>
                    </b-card-header>
                    <b-card-body>
                        ...
                        <div class="live-preview">
                            <div class="hstack gap-2 flex-wrap mb-3">
                                <b-link v-b-toggle.collapse-7 class="btn btn-primary" role="button">Toggle First
                                    Element
                                </b-link>
                                <b-button v-b-toggle.collapse-8 variant="primary"> Toggle Second Element</b-button>
                                <b-button v-b-toggle.collapse-7.collapse-8 type="button" variant="primary"> Toggle Both
                                    Elements
                                </b-button>
                            </div>
                            <b-row>
                                <b-col>
                                    <b-collapse id="collapse-7" class="multi-collapse" visible>
                                        <b-card class="card-body mb-0" no-body>
                                ...
                                <b-col>
                                    <b-collapse id="collapse-8" class="multi-collapse" visible>
                                        <b-card class="card-body mb-0" no-body>
