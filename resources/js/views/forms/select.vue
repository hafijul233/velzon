            ...
            <b-col lg="12">
                <b-card no-body>
                    <b-card-header class="align-items-center d-flex">
                        <b-card-title class="mb-0 flex-grow-1">Default Select</b-card-title>
                        <div class="flex-shrink-0">
                            <div class="form-check form-switch form-switch-right form-switch-md">
                                <label class="form-label text-muted" for="FormSelectDefault">Show Code</label>
                                <input id="FormSelectDefault" class="form-check-input code-switcher" type="checkbox"/>
                            </div>
                        </div>
                    </b-card-header>
                    <b-card-body>
                        ...
                        <div class="live-preview">
                            <b-row>
                                ...
                                <b-col lg="6">
                                    <select aria-label="Default select example" class="form-select rounded-pill mb-3">
...
&lt;/select&gt;</code></pre>
        ...
        <b-row>
            <b-col lg="12">
                <b-card no-body>
                    <b-card-header class="align-items-center d-flex">
                        <b-card-title class="mb-0 flex-grow-1">Menu Size</b-card-title>
                        <div class="flex-shrink-0">
                            <div class="form-check form-switch form-switch-right form-switch-md">
                                <label class="form-label text-muted" for="FormSelectMenuSizing">Show Code</label>
                                <input id="FormSelectMenuSizing" class="form-check-input code-switcher"
                                       type="checkbox"/>
                            </div>
                        </div>
                    </b-card-header>
...
&lt;/select&gt;</code></pre>
        ...
        <b-row>
            <b-col lg="12">
                <b-card no-body>
                    <b-card-header class="align-items-center d-flex">
                        <b-card-title class="mb-0 flex-grow-1">Select Size</b-card-title>
                        <div class="flex-shrink-0">
                            <div class="form-check form-switch form-switch-right form-switch-md">
                                <label class="form-label text-muted" for="FormSelectSizing">Show Code</label>
                                <input id="FormSelectSizing" class="form-check-input code-switcher" type="checkbox"/>
                            </div>
                        </div>
                    </b-card-header>
                    <b-card-body>
                        ...
                        <div class="live-preview">
                            <b-row class="align-items-center g-3">
                                ...
                                <b-col lg="4">
                                    <select aria-label=".form-select-sm example" class="form-select">
                                        <option selected>Open this select menu</option>
                                        <option value="1">One</option>
                                        <option value="2">Two</option>
                                        <option value="3">Three</option>
                                ...
                                <b-col lg="4">
                                    <select aria-label=".form-select-lg example" class="form-select form-select-lg">
                                        <option selected>Open this select menu</option>
                                        <option value="1">One</option>
                                        <option value="2">Two</option>
                                        <option value="3">Three</option>
