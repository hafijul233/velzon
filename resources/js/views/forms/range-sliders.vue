                        ...
                        <b-row>
                            ...
                            <b-col md="6">
                                <div class="p-3">
                                    ...
                                    <div class="p-3">
                                        <Slider v-model="sliderCustomzie" :max="500" :min="100"/>
                                    </div>
                                </div>
                            </b-col>
                        </b-row>
                        <b-row>
                            <b-col md="6">
                                <div class="p-3">
                                    ...
                                    <div class="p-3">
                                        <Slider v-model="sliderWithLabel.value" :data="sliderWithLabel.data"
                        ...
                        <b-row>
                            ...
                            <b-col md="6">
                                <div class="p-3">
                                    ...
                                    <div class="p-3">
                                        <Slider v-model="value" :format="format" :merge="merge"/>
                                    </div>
                                </div>
                            </b-col>
                        </b-row>
