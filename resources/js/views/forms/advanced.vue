                            ...
                            <b-col lg="6">
                                <div>
                                    ...
                                    <div data-input-flag data-option-flag-name>
                                        <input aria-expanded="false" class="form-control rounded-end flag-input" data-bs-toggle="dropdown"
                                               placeholder="Select country"
                                               readonly type="text"/>
                                        <div class="dropdown-menu w-100">
                                            <div class="p-2 px-3 pt-1 searchlist-input">
                                                <input class="form-control form-control-sm border search-countryList"
                                ...
                                <div class="mt-3">
                                    ...
                                    <div data-input-flag data-option-flag-name data-search-input="false">
                                        <input aria-expanded="false" class="form-control rounded-end flag-input" data-bs-toggle="dropdown" placeholder="Select country"
                                               readonly type="text"
                                               value=""/>
                                        <div class="dropdown-menu w-100">
                                            <div class="p-2 px-3 pt-1 searchlist-input">
                            ...
                            <b-col lg="6">
                                <div>
                                    ...
                                    <div class="input-group" data-input-flag>
                                        <button aria-expanded="false" class="btn btn-light border" data-bs-toggle="dropdown"
                                                type="button"><img alt="flag img"
                                                                           class="country-flagimg rounded" height="20"
                                                                           src="@/assets/images/flags/us.svg"><span
                                            class="ms-2 country-codeno">+ 1</span></button>
                                        <input class="form-control rounded-end flag-input" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" placeholder="Enter number"
                                               type="text"
                                               value=""/>
                                        <div class="dropdown-menu w-100">
                                            <div class="p-2 px-3 pt-1 searchlist-input">
                                ...
                                <b-col sm="6">
                                    <div>
                                        ...
                                        <div class="input-step">
                                            ...
                                            <input class="product-quantity" max="100" min="0" readonly type="number"
                                                   value="2"/>
                                    ...
                                    <b-col sm="6">
                                        <div>
                                            ...
                                            <div class="input-step full-width">
                                                <button class="minus" type="button">–</button>
                                                <input class="product-quantity" max="100" min="0" readonly
                                                       type="number" value="4"/>
                                                <button class="plus" type="button">+</button>
                                            </div>
                                        </div>
                ...
                'bg-danger': maxlen.length === 10,
                  ...
                  'bg-danger': option.length === 25,
                        ...
                        <div>
                            ...
                            <textarea v-model="textarea" :maxlength="225" class="form-control" placeholder="This textarea has a limit of 225 chars."
                                      rows="3"></textarea>
                            <div class="text-center">
                                <p v-if="textarea" :class="{
