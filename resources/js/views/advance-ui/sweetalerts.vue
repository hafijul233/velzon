                            ...
                            <table class="table table-nowrap align-middle justify-content-center mb-0">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <b-button id="sa-basic" size="sm" type="button" variant="primary"
                                                  @click="showAlert">
                                            Click me
                                        </b-button>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <b-button id="sa-title" size="sm" type="button" variant="primary"
                                                  @click="titleText">
                                            Click me
                                        </b-button>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <b-button id="sa-success" size="sm" type="button" variant="primary"
                                                  @click="successmsg">
                                            Click me
                                        </b-button>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <b-button id="sa-error" size="sm" type="button" variant="primary"
                                                  @click="saError">
                                            Click me
                                        </b-button>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <b-button id="sa-longcontent" size="sm" type="button" variant="primary"
                                                  @click="content">
                                            Click me
                                        </b-button>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <b-button id="sa-warning" size="sm" type="button" variant="primary"
                                                  @click="confirm">
                                            Click me
                                        </b-button>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <b-button id="sa-params" size="sm" type="button" variant="primary"
                                                  @click="cancel">
                                            Click me
                                        </b-button>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <b-button id="sa-image" size="sm" type="button" variant="primary"
                                                  @click="imageHeader">
                                            Click me
                                        </b-button>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <b-button id="sa-close" size="sm" type="button" variant="primary"
                                                  @click="timer">
                                            Click me
                                        </b-button>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <b-button id="custom-html-alert" size="sm" type="button" variant="primary"
                                                  @click="custom">
                                            Click me
                                        </b-button>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <b-button id="sa-dialog-three-btn" size="sm" type="button" variant="primary"
                                                  @click="threeButton">
                                            Click me
                                        </b-button>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <b-button id="sa-position" size="sm" type="button" variant="primary"
                                                  @click="position">
                                            Click me
                                        </b-button>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <b-button id="custom-padding-width-alert" size="sm" type="button"
                                                  variant="primary"
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <b-button id="ajax-alert" size="sm" type="button" variant="primary"
                                                  @click="ajax">
                                            Click me
                                        </b-button>
                                    </td>
