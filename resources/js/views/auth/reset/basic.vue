                    ...
                    <b-col lg="6" md="8" xl="5">
                        <b-card class="mt-4" no-body>
                            ...
                            <b-card-body class="p-4">
                                ...
                                <b-alert class="alert-borderless text-center mb-2 mx-2" show variant="warning">
                                ...
                                <div class="p-2">
                                    <form>
                                        ...
                                        <div class="text-center mt-4">
                                            <b-button class="w-100" type="submit" variant="success">Send Reset Link
                                            </b-button>
                                        </div>
                                    </form>
                                </div>
                        ...
                        <div class="mt-4 text-center">
                            <p class="mb-0">Wait, I remember my password...
                                <router-link class="fw-semibold text-primary text-decoration-underline"
                                             to="/auth/signin-basic"> Click here
                                </router-link>
                            </p>
                        </div>
