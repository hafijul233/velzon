                            ...
                            <b-card-body class="p-4">
                                ...
                                <div class="p-2 mt-4">
                                    <form>
                                        ...
                                        <div class="mb-3">
                                            <div class="float-end">
                                                <router-link class="text-muted" to="/auth/reset-pwd-basic">Forgot
                                                    password?
                                                </router-link>
                                            </div>
                                            <label class="form-label" for="password-input">Password</label>
                                            <div class="position-relative auth-pass-inputgroup mb-3">
                                                <input id="password-input" class="form-control pe-5"
                                        ...
                                        <div class="mt-4">
                                            <b-button class="w-100" type="submit" variant="success">Sign In</b-button>
                                        </div>
