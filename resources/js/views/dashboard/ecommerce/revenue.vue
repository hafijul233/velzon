...
<template>
    <b-card no-body>
            ...
            <b-row class="g-0 text-center">
                <b-col cols="6" sm="3">
                    <div class="p-3 border border-dashed border-start-0">
                        <h5 class="mb-1">
                            <count-to :duration="4000" :endVal="7585" :startVal="0"></count-to>
                        </h5>
                ...
                <b-col cols="6" sm="3">
                    <div class="p-3 border border-dashed border-start-0">
                        <h5 class="mb-1">
                            $
                            <count-to :duration="4000" :endVal="22" :startVal="0"></count-to>
                            k
                        </h5>
                ...
                <b-col cols="6" sm="3">
                    <div class="p-3 border border-dashed border-start-0">
                        <h5 class="mb-1">
                            <count-to :duration="4000" :endVal="367" :startVal="0"></count-to>
                        </h5>
                ...
                <b-col cols="6" sm="3">
                    <div class="p-3 border border-dashed border-start-0 border-end-0">
                        <h5 class="mb-1 text-primary">
                            <count-to :duration="4000" :endVal="18" :startVal="0"></count-to>
                            %
                        </h5>
        ...
        <b-card-body class="p-0 pb-2">
            <div class="w-100">
                <apexchart :options="chartOptions" :series="series" class="apex-charts" dir="ltr" height="380"
                           type="line">
                </apexchart>
            </div>
        </b-card-body>
