...
<template>
                                ...
                                <div class="mt-3 mt-lg-0">
                                    <form action="javascript:void(0);">
                                        <b-row class="g-3 mb-0 align-items-center">
                                            ...
                                            <div class="col-auto">
                                                <b-button class="btn-icon waves-effect layout-rightside-btn" type="button"
                                                          variant="soft-info"
                                                          @click="rightcolumn">
                            ...
                            <b-card class="card-animate" no-body>
                                <b-card-body>
                                    ...
                                    <div class="d-flex align-items-end justify-content-between mt-4">
                                        <div>
                                            <h4 class="fs-22 fw-semibold ff-secondary mb-4">
                                                <count-to :duration='5000' :endVal='36894' :startVal='0'></count-to>
                                            </h4>
                                            <b-link class="text-decoration-underline" href="">View all orders</b-link>
                                        </div>
                                        <div class="avatar-sm flex-shrink-0">
                            ...
                            <b-card no-body>
                                ...
                                <b-card-body>
                                                        ...
                                                        <div>
                                                            <h5 class="fs-14 my-1">
                                                                <router-link class="text-reset"
                                                                             to="/ecommerce/product-details">Branded T-Shirts
                                                                </router-link>
                                                            </h5>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="fs-14 my-1">
                                                                <router-link class="text-reset"
                                                                             to="/ecommerce/product-details">Bentwood Chair
                                                                </router-link>
                                                            </h5>
                                                ...
                                                <td>
                                                    <h5 class="fs-14 my-1 fw-normal">
                                                        <b-badge class="badge-soft-danger" variant="soft-danger">Out of
                                                            stock
                                                        </b-badge>
                                                    </h5>
                                                    <span class="text-muted">Stock</span>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="fs-14 my-1">
                                                                <router-link class="text-reset"
                                                                             to="/ecommerce/product-details">Borosil Paper Cup
                                                                </router-link>
                                                            </h5>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="fs-14 my-1">
                                                                <router-link class="text-reset"
                                                                             to="/ecommerce/product-details">One Seater Sofa
                                                                </router-link>
                                                            </h5>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="fs-14 my-1">
                                                                <router-link class="text-reset"
                                                                             to="/ecommerce/product-details">Stillbird Helmet
                                                                </router-link>
                                                            </h5>
                                    ...
                                    <b-row
                                        ...
                                        <b-col class="mt-3 mt-sm-0" sm="auto">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="fs-14 my-1 fw-medium">
                                                                <router-link class="text-reset"
                                                                             to="/ecommerce/seller-details">iTest Factory
                                                                </router-link>
                                                            </h5>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <h5 class="fs-14 my-1 fw-medium">
                                                                <router-link class="text-reset"
                                                                             to="/ecommerce/seller-details">Digitech Galaxy
                                                                </router-link>
                                                            </h5>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="flex-gow-1">
                                                            <h5 class="fs-14 my-1 fw-medium">
                                                                <router-link class="text-reset"
                                                                             to="/ecommerce/seller-details">Nesta Technologies
                                                                </router-link>
                                                            </h5>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <h5 class="fs-14 my-1 fw-medium">
                                                                <router-link class="text-reset"
                                                                             to="/ecommerce/seller-details">Zoetic Fashion
                                                                </router-link>
                                                            </h5>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <h5 class="fs-14 my-1 fw-medium">
                                                                <router-link class="text-reset"
                                                                             to="/ecommerce/seller-details">Meta4Systems
                                                                </router-link>
                                                            </h5>
                    ...
                    <b-row>
                        <b-col xl="4">
                            <b-card class="card-height-100" no-body>
                                ...
                                <b-card-body>
                                    <apexchart :options="chartOptions" :series="series" class="apex-charts"
                                               dir="ltr"></apexchart>
                                </b-card-body>
                            </b-card>
                        </b-col>
                        ...
                        <b-col xl="8">
                            <b-card no-body>
                                <b-card-header class="align-items-center d-flex">
                                    ...
                                    <div class="flex-shrink-0">
                                        <b-button size="sm" type="button" variant="soft-info">
                                ...
                                <b-card-body>
                                    <div class="table-responsive table-card">
                                        <table
                                            ...
                                            <tr>
                                                <td>
                                                    <router-link class="fw-medium link-primary"
                                                                 to="/ecommerce/order-details">#VZ2112
                                                    </router-link>
                                                </td>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                ...
                                                <td>
                                                    <b-badge class="badge-soft-success" variant="soft-success">Paid
                                                    </b-badge>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <router-link class="fw-medium link-primary"
                                                                 to="/ecommerce/order-details">#VZ2111
                                                    </router-link>
                                                </td>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                ...
                                                <td>Micro Design</td>
                                                <td>
                                                    <b-badge class="badge-soft-warning" variant="soft-warning">Pending
                                                    </b-badge>
                                                </td>
                                                <td>
                                                    <h5 class="fs-14 fw-medium mb-0">
                                            ...
                                            <tr>
                                                <td>
                                                    <router-link class="fw-medium link-primary"
                                                                 to="/ecommerce/order-details">#VZ2109
                                                    </router-link>
                                                </td>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                            ...
                                            <tr>
                                                <td>
                                                    <router-link class="fw-medium link-primary"
                                                                 to="/ecommerce/order-details">#VZ2108
                                                    </router-link>
                                                </td>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                ...
                                                <td>
                                                    <b-badge class="badge-soft-danger" variant="soft-danger">Unpaid
                                                    </b-badge>
                                                </td>
                                                <td>
                                                    <h5 class="fs-14 fw-medium mb-0">
                                            ...
                                            <tr>
                                                <td>
                                                    <router-link class="fw-medium link-primary"
                                                                 to="/ecommerce/order-details">#VZ2107
                                                    </router-link>
                                                </td>
                                                <td>
                                                    <div class="d-flex align-items-center">
                ...
                <div class="layout-rightside">
                    <b-card class="h-100 rounded-0" no-body>
                        <b-card-body class="p-0">
                            ...
                            <SimpleBar class="p-3 pt-0" data-simplebar style="max-height: 410px">
                                <div class="acitivity-timeline acitivity-main">
                                    ...
                                    <div class="acitivity-item py-3 d-flex">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            ...
                                            <div class="d-inline-flex gap-2 border border-dashed p-2 mb-2">
                                                <b-link class="bg-light rounded p-1" to="/ecommerce/product-details">
                                                    <img alt="" class="img-fluid d-block"
                                    ...
                                    <div class="acitivity-item py-3 d-flex">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <h6 class="mb-1 lh-base">
                                                Today offers by
                                                <router-link class="link-secondary" to="/ecommerce/seller-details">
                                                    Digitech Galaxy
                                                </router-link>
                                            </h6>
                            ...
                            <div class="p-3 mt-2">
                                ...
                                <ol class="ps-3 text-muted">
                                    <li class="py-1">
                                        <b-link class="text-muted" href="#">Mobile & Accessories
                                            <span class="float-end">(10,294)</span>
                                        </b-link>
                                    </li>
                                    <li class="py-1">
                                        <b-link class="text-muted" href="#">Desktop <span
                                            class="float-end">(6,256)</span></b-link>
                                    </li>
                                    <li class="py-1">
                                        <b-link class="text-muted" href="#">Electronics <span
                                            class="float-end">(3,479)</span></b-link>
                                    </li>
                                    <li class="py-1">
                                        <b-link class="text-muted" href="#">Home & Furniture
                                            <span class="float-end">(2,275)</span>
                                        </b-link>
                                    </li>
                                    <li class="py-1">
                                        <b-link class="text-muted" href="#">Grocery <span
                                            class="float-end">(1,950)</span></b-link>
                                    </li>
                                    <li class="py-1">
                                        <b-link class="text-muted" href="#">Fashion <span
                                            class="float-end">(1,582)</span></b-link>
                                    </li>
                                    <li class="py-1">
                                        <b-link class="text-muted" href="#">Appliances <span
                                            class="float-end">(1,037)</span></b-link>
                                    </li>
                                    <li class="py-1">
                                        <b-link class="text-muted" href="#">Beauty, Toys & More
                                            <span class="float-end">(924)</span>
                                        </b-link>
                                    </li>
                                    <li class="py-1">
                                        <b-link class="text-muted" href="#">Food & Drinks <span
                                            class="float-end">(701)</span></b-link>
                                    </li>
                                    <li class="py-1">
                                        <b-link class="text-muted" href="#">Toys & Games <span
                                            class="float-end">(239)</span></b-link>
                                    </li>
                                </ol>
                                <div class="mt-3 text-center">
                                    <b-link class="text-muted text-decoration-underline" href="javascript:void(0);">View
                                        all Categories
                                    </b-link>
                                </div>
                            </div>
  ...
  disableOnInteraction: false,
                                            ...
                                            :mousewheel="true" :slidesPerView="2"
                                            :spaceBetween="10" class="vertical-swiper" style="height: 250px">
                                        <swiper-slide>
                                            <div class="swiper-slide">
                                                <b-card class="border border-dashed shadow-none" no-body>
                                                    <b-card-body>
                                                        <div class="d-flex">
                                                            <div class="flex-shrink-0 avatar-sm">
                                                                <div class="avatar-title bg-light rounded">
                                                                    <img alt=""
                                                                         height="30" src="@/assets/images/companies/img-1.png"/>
                                                                </div>
                                                            </div>
                                                            <div class="flex-grow-1 ms-3">
                                                                <div>
                                                    ...
                                                    <b-card-body>
                                                        <div class="d-flex">
                                                            <div class="flex-shrink-0 avatar-sm">
                                                                <div class="avatar-title bg-light rounded">
                                                                    <img alt=""
                                                                         height="30" src="@/assets/images/companies/img-8.png"/>
                                                                </div>
                                                            </div>
                                                            <div class="flex-grow-1 ms-3">
                                                                <div>
                            ...
                            <div class="p-3">
                                ...
                                <div class="mt-3">
                                    <b-row class="align-items-center g-2">
                                        ...
                                        <b-col>
                                            <div class="p-1">
                                                <b-progress :value="50.16" class="animated-progess progress-sm"
                                                            variant="success"/>
                                            </div>
                                        </b-col>
                                        <div class="col-auto">
                                    ...
                                    <b-row class="align-items-center g-2">
                                        ...
                                        <b-col>
                                            <div class="p-1">
                                                <b-progress :value="29.32" class="animated-progess progress-sm"
                                                            variant="success"/>
                                            </div>
                                        </b-col>
                                        <div class="col-auto">
                                    ...
                                    <b-row class="align-items-center g-2">
                                        ...
                                        <b-col>
                                            <div class="p-1">
                                                <b-progress :value="18.12" class="animated-progess progress-sm"
                                                            variant="warning"/>
                                            </div>
                                        </b-col>
                                        <div class="col-auto">
                                    ...
                                    <b-row class="align-items-center g-2">
                                        ...
                                        <b-col>
                                            <div class="p-1">
                                                <b-progress :value="4.98" class="animated-progess progress-sm"
                                                            variant="success"/>
                                            </div>
                                        </b-col>
                                    ...
                                    <b-row class="align-items-center g-2">
                                        ...
                                        <b-col>
                                            <div class="p-1">
                                                <b-progress :value="7.42" class="animated-progess progress-sm"
                                                            variant="danger"/>
                                            </div>
                                        </b-col>
                                        <div class="col-auto">
                            ...
                            <b-card class="sidebar-alert bg-light border-0 text-center mx-4 mb-0 mt-3" no-body>
                                <b-card-body>
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <b-button class="btn-label" pill type="button" variant="primary">
