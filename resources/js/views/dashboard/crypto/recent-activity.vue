<script>
import {ArrowDownCircleIcon, ArrowUpCircleIcon, SendIcon} from '@zhuowenli/vue-feather-icons';
            ...
            <div data-simplebar style="height: 390px">
                <div class="p-3">
                    ...
                    <template v-for="(item, index) of recentActivity" :key="index">
                        <div v-if="item.isDate != true" class="d-flex align-items-center mb-3">
                ...
                <span class="avatar-title bg-light rounded-circle">
                  ...
                  <template v-if="item.feaIcon == 'send'">
                    ...
                    <div class="mt-3 text-center">
                        <b-link class="text-muted text-decoration-underline" href="javascript:void(0);">Load More
                        </b-link>
                    </div>
                </div>
            </div>
