    ...
    <b-card no-body>
        <b-card-header class="border-0 align-items-center d-flex">
            ...
            <div class="hstack gap-1">
                <b-button size="sm" type="button" variant="soft-secondary">1H</b-button>
                <b-button size="sm" type="button" variant="soft-secondary">7D</b-button>
                <b-button size="sm" type="button" variant="soft-secondary">1M</b-button>
                <b-button size="sm" type="button" variant="soft-secondary">1Y</b-button>
                <b-button size="sm" type="button" variant="soft-primary">ALL</b-button>
            </div>
        </b-card-header>
        ...
        <b-card-body class="p-0 pb-3">
            <apexchart :options="chartOptions" :series="series" class="apex-charts" dir="ltr" height="294"></apexchart>
