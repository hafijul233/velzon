...
<template>
    <b-card class="card-height-100" no-body>
        <b-card-header class="border-0 align-items-center d-flex">
            ...
            <div>
                <div class="dropdown">
                    <button aria-expanded="false" aria-haspopup="true" class="btn btn-soft-primary btn-sm"
        ...
        <b-card-body>
            <apexchart :options="chartOptions" :series="series" class="apex-charts" dir="ltr" height="224"></apexchart>
