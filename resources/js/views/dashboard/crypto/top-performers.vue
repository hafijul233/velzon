    ...
    <b-card class="card-height-100" no-body>
        <b-card-header class="align-items-center d-flex">
            ...
            <div class="hstack gap-1">
                <b-button size="sm" type="button" variant="soft-info">1H</b-button>
                <b-button size="sm" type="button" variant="soft-info">1D</b-button>
                <b-button size="sm" type="button" variant="soft-info">7D</b-button>
                <b-button size="sm" type="button" variant="soft-primary">1M</b-button>
            </div>
        </b-card-header>
        <b-card-body class="p-0">
            <ul class="list-group list-group-flush border-dashed mb-0">
                <li v-for="(item, index) of topPerformers" :key="index"
