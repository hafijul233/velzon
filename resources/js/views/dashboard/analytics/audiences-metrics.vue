        ...
        <b-card-header class="p-0 border-0 bg-soft-light">
            <b-row class="g-0 text-center">
                ...
                <b-col cols="6" sm="4">
                    <div class="p-3 border border-dashed border-start-0">
                        <h5 class="mb-1">
                            <count-to :duration='4000' :endVal='1278' :startVal='0'></count-to>
                ...
                <b-col cols="6" sm="4">
                    <div class="p-3 border border-dashed border-start-0 border-end-0">
                        <h5 class="mb-1">
                            <count-to :duration='4000' :endVal='3' :startVal='0'></count-to>
                            m
                            <count-to :duration='4000' :endVal='40' :startVal='0'></count-to>
                            sec
