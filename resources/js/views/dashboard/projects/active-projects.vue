    ...
    <b-card no-body>
        <b-card-header class="d-flex align-items-center">
            ...
            <div class="flex-shrink-0">
                <b-link class="btn btn-soft-info btn-sm" href="javascript:void(0);">Export Report</b-link>
            </div>
        </b-card-header>
        <b-card-body>
            <div class="table-responsive table-card">
                <table class="table table-nowrap table-centered align-middle">
                    ...
                    <tr v-for="(item, index) of activeProjects" :key="index">
                        ...
                        <td>
                            <img :src="item.img" alt="" class="avatar-xxs rounded-circle me-1"/>
                            <b-link class="text-reset" href="javascript: void(0);">{{ item.projectLead }}</b-link>
                        </td>
                        <td>
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0 me-1 text-muted fs-13">{{ item.percentage }}</div>
                                <b-progress :value="53" class="progress-sm flex-grow-1 rounded" variant="primary"/>
                            </div>
                        </td>
                        <td>
                            <div class="avatar-group flex-nowrap">
                                <div v-for="(subitem, index) of item.subItem" :key="index" class="avatar-group-item">
                                    <b-link class="d-inline-block" href="javascript: void(0);">
