...
<template>
    <b-card class="b-card card-height-100" no-body>
        <b-card-header class="align-items-center d-flex">
            <b-card-title class="mb-0 flex-grow-1">Projects Status</b-card-title>
            <div class="flex-shrink-0">
                <div class="dropdown card-header-dropdown">
                    <b-link aria-expanded="false" aria-haspopup="true" class="dropdown-btn text-muted" data-bs-toggle="dropdown"
                            href="#">
        ...
        <b-card-body>
            <apexchart :options="chartOptions" :series="series" class="apex-charts" dir="ltr" height="230"></apexchart>
            <div class="mt-3">
                <div class="d-flex justify-content-center align-items-center mb-4">
                    ...
                    <div>
                        ...
                        <p class="text-success fw-medium mb-0">
                            <b-badge class="badge-soft-success p-1" pill variant="soft-success"><i
