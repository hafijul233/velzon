        ...
        return {
            ...
            chartOptions: {
                ...
                colors: getChartColorsArray(
                    '["--vz-primary", "--vz-success","--vz-gray-400"]'
                ),
                fill: {
                    opacity: 0,
                        ...
                        <b-row class="g-0 text-center">
                            <b-col cols="6" sm="4">
                                <div class="p-3 border border-dashed border-start-0">
                                    <h5 class="mb-1">
                                        <count-to :duration="5000" :endVal="36" :startVal="0"></count-to>
                                        k
                                    </h5>
                            ...
                            <b-col cols="6" sm="4">
                                <div class="p-3 border border-dashed border-start-0">
                                    <h5 class="mb-1">
                                        <count-to :duration="5000" :endVal="92" :startVal="0"></count-to>
                                        k
                                    </h5>
                    ...
                    <div class="border-start p-4 h-100 d-flex flex-column">
                        <div class="w-100">
                            <div class="d-flex align-items-center">
                                <img alt=""
                                     class="img-fluid avatar-xs rounded-circle object-cover" src="https://img.themesbrand.com/velzon/images/img-2.gif"/>
                                <div class="ms-3 flex-grow-1">
                                    <h5 class="fs-16 mb-1 fw-bold">Trendy Fashion Portraits</h5>
                                    <p class="text-muted mb-0">Artwork</p>
                                </div>
                                <div class="dropdown">
                                    <b-link id="dropdownMenuButton5" aria-expanded="false" class="align-middle text-muted"
                                            data-bs-toggle="dropdown" href="javascript:void(0);" role="button">
                                        <i class="ri-share-line fs-18"></i>
                                    </b-link>
                                    <ul aria-labelledby="dropdownMenuButton5" class="dropdown-menu dropdown-menu-end">
                                        <li>
                            ...
                            <b-row class="mt-4 pt-2">
                                <b-col>
                                    <b-link class="btn btn-primary w-100" href="/apps/nft-item-detail">View Details
                                    </b-link>
                                </b-col>
                                <b-col>
                                    <b-button class="w-100" variant="info">Bid Now</b-button>
                                </b-col>
                            </b-row>
                        </div>
                    </div>
