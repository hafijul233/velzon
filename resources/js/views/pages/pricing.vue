...
<template>
    <Layout>
                    ...
                    <div class="d-inline-flex">
                        <ul id="pills-tab" class="nav nav-pills arrow-navtabs plan-nav rounded mb-3 p-1" role="tablist">
                            <li class="nav-item" role="presentation">
                                <b-button id="month-tab" aria-selected="true" class="nav-link fw-semibold active"
                                          data-bs-target="#month" data-bs-toggle="pill"
                                          role="tab" type="button" variant="link" @click="monthly">
                                    Monthly
                                </b-button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <b-button id="annual-tab" aria-selected="false" class="nav-link fw-semibold"
                                          data-bs-target="#annual" data-bs-toggle="pill"
                                          role="tab" type="button" variant="link" @click="anually">
                                    Annually
                                    <b-badge variant="success">25% Off</b-badge>
                                </b-button>
                            </li>
                        </ul>
                    </div>
        ...
        <b-row>
            <b-col lg="6" xxl="3">
                <b-card class="pricing-box" no-body>
                    <b-card-body class="bg-light m-2 p-4">
                        ...
                        <div class="mt-3 pt-2">
                            <b-link class="btn btn-danger disabled w-100" href="javascript:void(0);">Your Current Plan
                            </b-link>
                        </div>
                    </b-card-body>
                </b-card>
            ...
            <b-col lg="6" xxl="3">
                <b-card class="pricing-box" no-body>
                    <b-card-body class="bg-light m-2 p-4">
                        ...
                        <div class="mt-3 pt-2">
                            <b-link class="btn btn-info w-100" href="javascript:void(0);">Change Plan</b-link>
                        </div>
                    </b-card-body>
                </b-card>
            </b-col>
            ...
            <b-col lg="6" xxl="3">
                <b-card class="pricing-box ribbon-box right" no-body>
                    <b-card-body class="bg-light m-2 p-4">
            ...
            <b-col xl="9">
                <b-row>
                    <b-col lg="4">
                      ...
                      " href="javascript:void(0);">Sign up free
                                        </b-link>
                                    </div>
                                </div>
                            </b-card-body>
                    ...
                    <b-col lg="4">
                        ...
                        ">
                                ...
                                <div>
                                    ...
                                    <div class="mt-4">
                                        <b-link class="btn btn-success w-100 waves-effect waves-light"
                    ...
                    <b-col lg="4">
                        ...
                        w-100
                        waves-effect waves-light
                      " href="javascript:void(0);">Get started
                                        </b-link>
                                    </div>
                                </div>
                            </b-card-body>
        ...
        <b-row>
            <b-col lg="6">
                <b-card class="pricing-box text-center" no-body>
                    <b-row class="g-0">
                        <b-col lg="6">
                            <b-card-body class="h-100">
                                ...
                                <div class="text-center plan-btn mt-2">
                                    <b-link class="btn btn-success w-sm waves-effect waves-light"
            ...
            <b-col lg="6">
                <b-card class="pricing-box ribbon-box ribbon-fill text-center" no-body>
