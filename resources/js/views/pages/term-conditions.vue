            ...
            <b-col col lg="10">
                <b-card no-body>
                    <div class="bg-soft-warning position-relative">
                        ...
                        <div class="shape">
                            <svg height="60" preserveAspectRatio="none"
                                 version="1.1"
                                 viewBox="0 0 1440 60" width="1440" xmlns="http://www.w3.org/2000/svg"
                                 xmlns:svgjs="http://svgjs.com/svgjs"
                                 xmlns:xlink="http://www.w3.org/1999/xlink">
                                <g fill="none" mask="url(&quot;#SvgjsMask1001&quot;)">
                                    <path d="M 0,4 C 144,13 432,48 720,49 C 1008,50 1296,17 1440,9L1440 60L0 60z"
                                          style="fill: var(--vz-card-bg-custom);"></path>
                                </g>
                                <defs>
                                    <mask id="SvgjsMask1001">
                                        <rect fill="#ffffff" height="60" width="1440"></rect>
                                    </mask>
                                </defs>
                            </svg>
                        </div>
                    ...
                    <b-card-body class="p-4">
                        <div>
                            ...
                            <p class="text-muted">These terms and conditions outline the rules and regulations for the
                                use of Company
                        ...
                        <div>
                            ...
                            <p class="text-muted">Parts of this website offer an opportunity for users to post and
                                exchange opinions
                                and information in certain areas of the website. Company Name does not filter, edit,
                                publish or review
                        ...
                        <div>
                            <p class="text-muted">Company Name reserves the right to monitor all Comments and to remove
                                any Comments
                            ...
                            <p class="text-muted fw-semibold">No use of Company Name's logo or other artwork will be
                                allowed for
                        ...
                        <div class="text-end">
                            <b-link class="btn btn-success me-1" href="#!">Accept</b-link>
                            <b-link class="btn btn-outline-danger" href="#!"><i
                                class="ri-close-line align-bottom me-1"></i> Decline
                            </b-link>
                        </div>
                    </b-card-body>
                </b-card>
