                    ...
                    <b-card-body class="p-4">
                        <div class="d-flex">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <p class="text-muted">If you have additional questions or require more information about
                                    our Privacy
                        ...
                        <div class="d-flex">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <p class="text-muted">When you register for an Account, we may ask for your contact
                                    ...
                                    number.</p>
                                <p class="text-muted">We use the information we collect in various ways, including
                                    to:</p>
                                ...
                                <p class="text-muted">Like any other website, Website Name uses ‘cookies'. These cookies
                                    are used to
                        ...
                        <div class="d-flex">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <p class="text-muted"><b>Website Name's Privacy Policy does not apply to other
                                    ...
                                    for more detailed information. It may include their practices and instructions about
                                    how to opt-out
                                    of certain options. You may find a complete list of these Privacy Policies and their
                                    links here:
                        ...
                        <div class="text-end">
                            <b-link class="btn btn-danger" href="#!">I'm Understand</b-link>
                        </div>
                    </b-card-body>
                </b-card>
            </b-col>
