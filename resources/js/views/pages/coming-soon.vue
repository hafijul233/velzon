                    ...
                    <b-col lg="12">
                        <div class="text-center mt-sm-5 pt-4 mb-4">
                            <div class="mb-sm-5 pb-sm-4 pb-5">
                                <img alt="" class="move-animation" height="120" src="@/assets/images/comingsoon.png"/>
                            </div>
                            <div class="mb-5">
                            ...
                            <div>
                                ...
                                <div class="input-group countdown-input-group mx-auto my-4">
                                    <input aria-describedby="button-email" aria-label="search result"
                                           class="form-control border-light shadow"
                                           placeholder="Enter your email address" type="email"/>
                                    <b-button id="button-email" type="button" variant="success">
