                    ...
                    <b-card-body>
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                ...
                                <h2 class="mb-0">
                                    $
                                    <count-to :duration="5000" :endVal="243" :startVal="0"></count-to>
                                    <small
                    ...
                    <b-card-body>
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                ...
                                <h2 class="mb-0">
                                    $
                                    <count-to :duration="5000" :endVal="658" :startVal="0"></count-to>
                                    <small
                    ...
                    <b-card-body>
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                ...
                                <h2 class="mb-0">
                                    $
                                    <count-to :duration="5000" :endVal="104" :startVal="0"></count-to>
                                    <small
                    ...
                    <b-card-body>
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                ...
                                <h2 class="mb-0">
                                    $
                                    <count-to :duration="5000" :endVal="87" :startVal="0"></count-to>
                                    <small
            ...
            <b-col xxl="9">
                <b-card class="card-height-100" no-body>
                                    ...
                                    <div class="d-flex flex-wrap gap-4 align-items-center">
                                        <div>
                                            ...
                                            <p class="text-muted text-uppercase fw-medium mb-0">
                                                Bitcoin (BTC)
                                                <b-badge class="badge-soft-success" variant="soft-success"><i
                    ...
                    <b-card-body class="p-0 pb-3">
                        <apexchart :options="options.chartOptions" :series="options.series" class="apex-charts"
                                   dir="ltr"
                ...
                <b-card class="card-height-100" no-body>
                    ...
                    <b-card-body class="p-0">
                        <div class="tab-content text-muted">
                            <div id="cryptoBuy" class="tab-pane active" role="tabpanel">
                            ...
                            <div id="cryptoSell" class="tab-pane" role="tabpanel">
                                <div class="p-3 bg-soft-warning">
                                    <div class="float-end ms-2">
                                        <h6 class="text-warning mb-0">
                                            USD Balance : <span class="text-dark">$12,426.07</span>
                                ...
                                <div class="p-3">
                                    ...
                                    <div class="mt-3 pt-2">
                                        <b-button class="w-100" type="button" variant="danger">
                                            Sell Coin
                                        </b-button>
                                    </div>
                                </div>
        ...
        <b-card no-body>
            ...
            <b-card-body class="p-0 border-bottom border-bottom-dashed">
                <div class="search-box">
                    <input class="form-control search border-0 py-3" placeholder="Search to currency..." type="text"/>
            ...
            <b-card-body>
                <div class="table-responsive table-card">
                    ...
                    'text-success': data.volume < 1,
                            ...
                            <td>
                                <b-button size="sm" varient="soft-info">Trade Now</b-button>
                            </td>
                        </tr>
                        </tbody>
                    </table>
