...
<template>
                    ...
                    <b-card-header>
                        <div class="d-flex align-items-center">
                            ...
                            <div class="toolbar d-flex align-items-start justify-content-center flex-wrap gap-2">
                                <b-button id="one_month" class="timeline-btn" size="sm" type="button"
                                          variant="soft-primary">
                                    1M
                                </b-button>
                                <b-button id="six_months" class="timeline-btn" size="sm" type="button"
                                          variant="soft-primary">
                                    6M
                                </b-button>
                                <b-button id="one_year" class="timeline-btn" size="sm" type="button"
                                          variant="soft-primary">
                                    1Y
                                </b-button>
                                <b-button id="all" class="timeline-btn active" size="sm" type="button"
                                          variant="soft-primary">
                                    ALL
                                </b-button>
                            </div>
  ...
  1600: {
    slidesPerView: 4,
        ...
        }" :slidesPerView="1" :spaceBetween="24" class="cryptoSlider">
                        ...
                        <swiper-slide>
                            <b-card no-body>
                                <b-card-body>
                                    <div class="float-end">
                                        <div class="dropdown">
                                            <b-link aria-expanded="false" aria-haspopup="true" class="text-reset"
                        ...
                        <span class="text-muted fs-18">
                          <i class="mdi mdi-dots-horizontal"></i>
                                    ...
                                    <b-row class="align-items-end g-0">
                                        ...
                                        <b-col cols="6">
                                            <apexchart :key="item.id" :options="item.chartOptions"
                ...
                <b-card id="marketList" no-body>
                    <b-card-header class="border-bottom-dashed d-flex align-items-center">
                        ...
                        <div class="flex-shrink-0">
                            <b-btn-group class="btn-group">
                                <b-button size="sm" type="button" variant="primary">
                                    Today
                                </b-button>
                                <b-button size="sm" type="button" variant="outline-primary">
                                    Overall
                                </b-button>
                            </b-btn-group>
                        </div>
                    ...
                    <b-card-body>
                        <div class="table-responsive table-card">
                            <table id="customerTable" class="table align-middle table-nowrap">
                                ...
                                <tr v-for="(data, index) of resultQuery" :key="index">
                                    <td class="id" style="display: none">
                                        <b-link class="fw-medium link-primary" href="javascript:void(0);">#VZ001
                                        </b-link>
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center fw-medium">
                                            <img :src="data.image" alt="" class="avatar-xxs me-2"/>
                                            <b-link class="currency_name" href="javascript:void(0)">{{
                                                    data.currency_name
                                                }}
                                            </b-link>
                                        </div>
                        ...
                        <div class="d-flex justify-content-end mt-3">
                            <div class="pagination-wrap hstack gap-2">
                                <b-link v-if="page != 1 || resultQuery.length >= 6"
                                ...
                                <ul v-if="resultQuery.length >= 6" class="pagination listjs-pagination mb-0">
                                    <li v-for="(pageNumber, index) in pages.slice(
                    page - 1,
                    page + 5
                  )" :key="index" class="active" @click="page = pageNumber">
            ...
            <b-col xxl="3">
                    ...
                    <b-card-body class="bg-soft-warning">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                ...
                                <p class="text-muted mb-0">
                                    $25,10,974
                                    <b-badge class="badge-soft-success" tag="small" variant="soft-success"><i
                                        class="ri-arrow-right-up-line fs-13 align-bottom"></i>4.37%
                                    </b-badge>
                                </p>
                            </div>
                            <div class="flex-shrink-0">
                        ...
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                ...
                                <p class="text-muted mb-0">
                                    $9,10,564
                                    <b-badge class="badge-soft-success" tag="small" variant="soft-success"><i
                                        class="ri-arrow-right-up-line fs-13 align-bottom"></i>1.25%
                                    </b-badge>
                                </p>
                            </div>
                            <div class="flex-shrink-0">
                        ...
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                ...
                                <p class="text-muted mb-0">
                                    $18,22,730
                                    <b-badge class="badge-soft-success" tag="small" variant="soft-success"><i
                                        class="ri-arrow-right-up-line fs-13 align-bottom"></i>8.34%
                                    </b-badge>
                                </p>
                            </div>
                            <div class="flex-shrink-0">
                ...
                <b-card no-body>
                    ...
                    <b-card-body>
                        ...
                        <div class="d-flex mb-3">
                            <div class="flex-shrink-0">
                                <img alt="" class="avatar-xxs" src="@/assets/images/svg/crypto-icons/ltc.svg"/>
                            </div>
                            <div class="flex-grow-1 ms-3">
                        ...
                        <div class="d-flex mb-3">
                            <div class="flex-shrink-0">
                                <img alt="" class="avatar-xxs" src="@/assets/images/svg/crypto-icons/xmr.svg"/>
                            </div>
                            <div class="flex-grow-1 ms-3">
                        ...
                        <div class="d-flex mb-3">
                            <div class="flex-shrink-0">
                                <img alt="" class="avatar-xxs" src="@/assets/images/svg/crypto-icons/fil.svg"/>
                            </div>
                            <div class="flex-grow-1 ms-3">
                        ...
                        <div class="d-flex mb-3">
                            <div class="flex-shrink-0">
                                <img alt="" class="avatar-xxs" src="@/assets/images/svg/crypto-icons/dot.svg"/>
                            </div>
                            <div class="flex-grow-1 ms-3">
                        ...
                        <div>
                            <router-link class="btn btn-soft-info w-100" to="/crypto/transactions">View All Transactions
