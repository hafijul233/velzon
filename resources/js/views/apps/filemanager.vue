...
<template>
    <Layout>
                ...
                <div class="p-3 d-flex flex-column h-100">
                    ...
                    <div class="mt-3 mx-n4 px-4 file-menu-sidebar-scroll" data-simplebar>
                        <ul class="list-unstyled file-manager-menu">
                            <li>
                                <b-link v-b-toggle.collapseExample role="button" @click="changefolder('Recent Files')">
                            ...
                            <li>
                                <b-link href="#!" @click="changetitle('Document')"><i
                                    class="ri-file-list-2-line align-bottom me-2"></i>
                                    <span class="file-list-link">Documents</span>
                                </b-link>
                            </li>
                            <li>
                                <b-link href="#!" @click="changetitle('Media')"><i
                                    class="ri-image-2-line align-bottom me-2"></i>
                                    <span class="file-list-link">Media</span>
                                </b-link>
                            </li>
                            <li>
                                <b-link href="#!" @click="changerecent('Recent')"><i
                                    class="ri-history-line align-bottom me-2"></i>
                                    <span class="file-list-link">Recents</span>
                                </b-link>
                            </li>
                            <li>
                                <b-link href="#!" @click="changetitle('Important')"><i
                                    class="ri-star-line align-bottom me-2"></i>
                                    <span class="file-list-link">Important</span>
                                </b-link>
                            </li>
                            <li>
                                <b-link href="#!" @click="changetitle('Deleted')"><i
                                    class="ri-delete-bin-line align-bottom me-2"></i>
            ...
            <div class="file-manager-content w-100 p-3 py-0">
                <div class="mx-n3 pt-4 px-4 file-manager-content-scroll" data-simplebar>
                            ...
                            <b-col>
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0 me-2 d-block d-lg-none">
                                        <b-button class="btn-icon fs-16 file-menu-btn" size="sm" type="button"
                    ...
                    'Documents',
                                    ...
                                    <b-button class="create-folder-modal text-nowrap flex-shrink-0" variant="success"
                                              @click="openFolderModal"><i class="ri-add-line align-bottom me-1"></i>
                                        Create Folders
                                    </b-button>
                                </div>
                            </b-col>
                        ...
                        <b-row id="folderlist-data">
                            <b-col v-for="(folder, index) of this.folders" :key="index" class=" folder-card" cols="6"
                                   xxl="3">
                                <b-card id="folder-1" class="bg-light shadow-none" no-body>
                                    <b-card-body>
                                        <div class="d-flex mb-1">
                                            <div class="form-check form-check-danger mb-3 fs-15 flex-grow-1">
                                                <input v-if="folder.ischecked" id="folderlistCheckbox_1" checked
                                                       class="form-check-input" type="checkbox"
                                                       value=""/>
                                                <input v-if="!folder.ischecked" id="folderlistCheckbox_1"
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    ...
                                                    <li>
                                                        <b-link class="dropdown-item edit-folder-list"
                                                                role="button" @click="editfolder(folder)">Rename
                                                        </b-link>
                                                    </li>
                                                    <li>
                                                        <b-link class="dropdown-item" role="button"
                                                                @click="deletefolder(folder)">Delete
                                                        </b-link>
                                                    </li>
                                                </ul>
                                            </div>
                    ...
                    <div>
                        <div class="d-flex align-items-center mb-3">
                            <h5 id="filetype-title" class="flex-grow-1 fs-16 mb-0">
                                Recent File
                            </h5>
                            <div class="flex-shrink-0">
                                <b-button class="create-folder-modal text-nowrap flex-shrink-0" variant="success"
                                          @click="openFileModal"><i class="ri-add-line align-bottom me-1"></i> Create
                                    File
                                </b-button>
                            </div>
                        </div>
                        <div class="table-responsive">
                            <table class="table align-middle table-nowrap mb-0">
                                ...
                                <tr v-for="(fileData, index) of this.filelist" :key="index">
                                    <td>
                                        <input id="filelist-{{fileData.id}}" class="form-control filelist-id"
                                               type="hidden"
                                               value="{{fileData.id}}"/>
                                        <div class="d-flex align-items-center">
                          ...
                          " class="ri-gallery-fill align-bottom text-success"></i>
                                                <i v-if="
                            fileData.fileName.includes('.') &&
                          ...
                          " class="ri-file-pdf-fill align-bottom text-danger"></i>
                                                <i v-if="
                            fileData.fileName.includes('.') &&
                            fileData.fileName.split('.')[1] == 'docx'
                          " class="ri-file-text-fill align-bottom text-secondary"></i>
                                                <i v-if="
                            fileData.fileName.includes('.') &&
                            fileData.fileName.split('.')[1] == 'txt'
                          " class="ri-file-text-fill align-bottom text-secondary"></i>
                                                <i v-if="!fileData.fileName.includes('.')"
                                                   class="ri-file-text-fill align-bottom text-secondary"></i>
                                            </div>
                                    ...
                                    <td>
                                        <div class="d-flex gap-3 justify-content-center">
                                            <button v-if="fileData.starred"
                                                    class="btn btn-ghost-primary btn-icon btn-sm favourite-btn active"
                                            ...
                                            <div class="dropdown">
                                                <b-button aria-expanded="false" class="btn-icon dropdown"
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li>
                                                        <b-link class="dropdown-item viewfile-list" href="#">View
                                                        </b-link>
                                                    </li>
                                                    <li>
                                                        <b-link class="dropdown-item edit-list"
                                                                role="button" @click="fileDataEdit(fileData)">Rename
                                                        </b-link>
                                                    </li>
                                                    <li class="dropdown-divider"></li>
                                                    <li>
                                                        <b-link class="dropdown-item remove-list" role="button"
                ...
                <div class="mx-n3 pt-3 px-3 file-detail-content-scroll" data-simplebar>
                    <div id="folder-overview">
                        <div class="d-flex align-items-center pb-3 border-bottom border-bottom-dashed">
                            ...
                            <div>
                                <b-button class="btn-icon fs-16 close-btn-overview" size="sm" type="button"
                                          variant="soft-danger"
                        ...
                        <apexchart :options="chartOptions" :series="series" class="apex-charts" dir="ltr"
                        ...
                        <div class="pb-3 mt-auto">
                            <b-alert class="d-flex align-items-center mb-0" show variant="danger">
                                <div class="flex-shrink-0">
                    ...
                    <div id="file-overview" class="h-100">
                        <div class="d-flex h-100 flex-column">
                            <div class="d-flex align-items-center pb-3 border-bottom border-bottom-dashed mb-3 gap-2">
                                ...
                                <div>
                                    <b-button class="btn-icon fs-16 favourite-btn" size="sm" type="button"
                            ...
                            <div class="pb-3 border-bottom border-bottom-dashed mb-3">
                                ...
                                <b-button class="btn-icon float-end fs-16" size="sm" type="button"
                            ...
                            <div class="mt-auto border-top border-top-dashed py-3">
                                <div class="hstack gap-2">
                                    <b-button class="w-100" type="button" variant="soft-primary">
                                        <i class="ri-download-2-line align-bottom me-1"></i>
                                        Download
                                    </b-button>
                                    <b-button class="w-100 remove-file-overview" type="button" variant="soft-danger">
        ...
        <b-modal v-model="folderModal" centered class="v-modal-custom" header-class="p-3 bg-soft-success"
                 hide-footer modal-class="zoomIn" title="Create Folder"
                 title-class="exampleModalLabelFolder">
            <b-form id="createfolder-form" autocomplete="off" class="needs-validation createfolder-form" novalidate>
                <div class="mb-4">
                    <div id="modal-id"></div>
                    <label class="form-label" for="foldername-input">Folder Name</label>
                    <input id="foldername-input" class="form-control" placeholder="Enter folder name" required
                           type="text"/>
                    <div class="invalid-feedback">Please enter a folder name.</div>
                    <input id="folderId" type="hidden">
                    <input id="folderid-input" class="form-control" placeholder="Enter folder name" type="hidden"
                           value=""/>
                </div>
                <div class="hstack gap-2 justify-content-end">
                    <b-button id="addFolderBtn-close" data-bs-dismiss="modal" type="button" variant="ghost-danger"
                              @click="folderModal = false">
                        <i class="ri-close-line align-bottom"></i> Close
                    </b-button>
                    <b-button id="updatefolder-btn" type="button" variant="success" @click="updateFolder">
                        Update
                    </b-button>
                    <b-button id="createfolder-btn" type="button" variant="primary" @click="createfolder">
                        Add Folder
                    </b-button>
                </div>
            </b-form>
        ...
        <b-modal v-model="fileModal" centered class="v-modal-custom" header-class="p-3 bg-soft-success"
                 hide-footer modal-class="zoomIn" title="Create File"
                 title-class="exampleModalLabel">
            <b-form id="createfile-form" autocomplete="off" class="needs-validation createfile-form" novalidate>
                <div class="mb-4">
                    <div id="modal-id"></div>
                    <label class="form-label" for="filename-input">File Name</label>
                    <input id="fileId" type="hidden">
                    <input id="filename-input" class="form-control" placeholder="Enter file name" required type="text"/>
                    <div class="invalid-feedback">Please enter a file name.</div>
                    <input id="fileid-input" class="form-control" placeholder="Enter file name" type="hidden"/>
                </div>
                <div class="hstack gap-2 justify-content-end">
                    <b-button id="addFileBtn-close" type="button" variant="ghost-danger" @click="fileModal = false">
                        <i class="ri-close-line align-bottom"></i> Close
                    </b-button>
                    <b-button id="updatefile-btn" type="button" variant="success" @click="updatefile">
                        Update
                    </b-button>
                    <b-button id="createfile-btn" type="button" variant="primary" @click="createNewfile">
                        Create
                    </b-button>
                </div>
            </b-form>
