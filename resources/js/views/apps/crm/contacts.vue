...
<template>
    <Layout>
        ...
        <b-row>
                        ...
                        <div class="d-flex align-items-center flex-wrap gap-2">
                            ...
                            <div class="flex-shrink-0">
                                <div class="hstack text-nowrap gap-2">
                                    ...
                                    <b-button id="dropdownMenuLink1" aria-expanded="false" class="btn btn-soft-info"
                                                ...
                                                <li class="list-inline-item">
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-end">
                                                            ...
                                                            <li>
                                                                <b-link class="dropdown-item edit-item-btn"
                                                                        @click="editdata(data)">
            ...
            <b-col xxl="3">
                <b-card id="contact-view-detail" no-body>
                    <b-card-body class="text-center">
                        <div class="position-relative d-inline-block">
                            <img id="image" alt="" class="avatar-lg rounded-circle img-thumbnail"
                                 src="@/assets/images/users/avatar-10.jpg">
                            <span class="contact-active position-absolute rounded-circle bg-success"><span
                                class="visually-hidden"></span></span>
                        </div>
                        <h5 id="name" class="mt-4 mb-1">Tonya Noble</h5>
                        <p id="company" class="text-muted">Nesta Technologies</p>
                            ...
                            <table class="table table-borderless mb-0">
                                ...
                                <tr>
                                    ...
                                    <td id="tags" class="hstack gap-1">
                                        <b-badge class="badge-soft-primary" variant="soft-primary">Lead</b-badge>
                                        <b-badge class="badge-soft-primary" variant="soft-primary">Partner</b-badge>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="fw-medium" scope="row">Last Contacted</td>
                                    <td><span id="lastdate">15 Dec, 2021 </span><small id="lasttime" class="text-muted">08:58AM</small>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
        ...
        <!-- add contact modal  -->
        <b-modal id="showmodal" v-model="addContactModal" centered class="v-modal-custom"
            ...
            <b-form id="addform" action="" autocomplete="off" class="tablelist-form">
                ...
                <b-row class="g-3">
                    ...
                    <b-col lg="12">
                        <div>
                            <label class="form-label" for="designation-field">Last Contacted</label>
                    ...
                    <b-col lg="12">
                        <div>
                            <label class="form-label" for="email_id-field">Email ID</label>
                            <input id="emailid" class="form-control" placeholder="Enter email" required type="text"/>
                        </div>
                    </b-col>
                    <b-col lg="6">
                        <div>
                    ...
                    <b-col lg="6">
                        <div>
                            <label class="form-label" for="lead_score-field">Lead Score</label>
                            <input id="leadscore" class="form-control" placeholder="Enter value" required type="text"/>
                        </div>
                    </b-col>
                    <div>
                ...
                <div class="hstack gap-2 justify-content-end mt-3">
                    <b-button id="edtclosemodal" type="button" variant="light" @click="addContactModal = false">Close
                    </b-button>
                    <b-button id="add-btn" type="button" variant="success" @click="addorder">Add Contact</b-button>
