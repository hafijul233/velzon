<script>
import {CheckSquareIcon, ClockIcon, FileTextIcon, XOctagonIcon} from "@zhuowenli/vue-feather-icons";
...
<template>
    <Layout>
        ...
        <b-row>
            <b-col v-for="(item, index) of invoiceWidgets" :key="index" md="6" xl="3">
                <b-card class="card-animate" no-body>
                    <b-card-body>
                        ...
                        <div class="d-flex align-items-end justify-content-between mt-4">
                            <div>
                                <h4 class="fs-22 fw-semibold ff-secondary mb-4">{{ item.prefix }}{{
                                        item.counter
                                    }}{{ item.suffix }}
                                </h4>
                                <b-badge class="bg-warning me-1">{{ item.badge }}</b-badge>
        ...
        <b-row>
            <b-col lg="12">
                <b-card id="invoiceList" no-body>
                    <b-card-header class="border-0">
                        <div class="d-flex align-items-center">
                            <h5 class="card-title mb-0 flex-grow-1">Invoices</h5>
                            <div class="flex-shrink-0">
                                <div class="d-flex gap-2 flex-wrap">
                                    <b-button id="remove-actions" class="me-1" variant="primary"
                                              @click="deleteMultiple">
                                        <i class="ri-delete-bin-2-line"></i>
                                    </b-button>
                                    <router-link class="btn btn-danger" to="/invoices/create"><i
                    ...
                    <b-card-body>
                        <div>
                            <div class="table-responsive table-card">
                                <table id="invoiceTable" class="table align-middle table-nowrap">
                                    ...
                                    <tr v-for="(item, index) of resultQuery" :key="index">
                                        ...
                                        <td class="id">
                                            <router-link class="fw-medium link-primary" to="/invoices/detail">
                                                {{ item.invoiceId }}
                                            </router-link>
                                        </td>
                                        ...
                                        <td class="date">{{ item.date }} <small class="text-muted">{{
                                                item.time
                                            }}</small></td>
                      ...
                      }" class="badge text-uppercase">{{ item.status }}</span></td>
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li>
                                                        ...
                                                        <router-link :to="'/invoices/detail/' + item._id"
                                                                     class="dropdown-item">
                      ...
                      disabled: pageNumber == '...',
                        ...
                        <!-- remove modal  -->
                        <b-modal id="deleteOrder" v-model="invoiceListModal" centered class="v-modal-custom"
                                 header-class="p-3 bg-light" hide-footer modal-class="flip" no-close-on-backdrop>
                            <lottie :height="90" :options="defaultOptions1"
                                    :width="90"
                                    class="avatar-xl" colors="primary:#405189,secondary:#f06548"/>
                            <div class="mt-4 text-center">
                                <h4>You are about to delete a order ?</h4>
                                <p class="text-muted fs-15 mb-4">Deleting your order will remove all of
                                    your information from our database.</p>
                                <div class="hstack gap-2 justify-content-center remove">
                                    <b-button class="btn-link fw-medium text-decoration-none" variant=""><i
                                        class="ri-close-line me-1 align-middle"></i> Close
                                    </b-button>
                                    <b-button id="delete-record" class="btn btn-danger">Yes, Delete It</b-button>
                                </div>
                            </div>
                        </b-modal>
