    ...
    <Layout>
        ...
        <b-row>
            <b-col xxl="9">
                            ...
                            <b-row class="g-3">
                                <b-col sm="6" xxl="5">
                                    <div class="search-box">
                                        <input id="searchCompany" class="form-control search bg-light border-light"
                                ...
                                <b-col sm="4" xxl="2">
                                    <div class="input-light">
                                        <select id="idType" class="form-control" data-choices
                                ...
                                <b-col sm="4" xxl="2">
                                    <b-button class="w-100" onclick="filterData();" type="button" variant="success">
                ...
                <b-row id="companies-list" class="job-list-row">

                    <b-col v-for="(data, index) of resultQuery" :key="index" md="6" xxl="3">
                        <b-card class="companiesList-card" no-body>
                            <b-card-body>
                                ...
                                <div>
                                    <b-button class="w-100 viewcompany-list" type="button" variant="soft-primary"
                ...
                <b-row id="pagination-element" class="g-0 justify-content-end mb-4">
                    <b-col sm="6">
                        <div
                            ...
                            <div class="page-item">
                                <b-link v-if="page != 1" id="page-prev" class="page-link" href="javascript:void(0);"
                                        @click="page--">
                                    Previous
                                </b-link>
                            </div>
                ...
                <span id="page-num" class="pagination">
                  <div v-for="(pageNumber, index) in pages" :key="index"
                    ...
                    <b-link class="page-link clickPageNumber" href="javascript:void(0);">{{ pageNumber }}</b-link>
                            ...
                            <div class="page-item">
                                <b-link v-if="page < pages.length" id="page-next" class="page-link"
            ...
            <b-col xxl="3">
                <b-card id="company-overview" no-body>
                    <b-card-body>
                        <div class="avatar-lg mx-auto mb-3">
                            <div class="avatar-title bg-light rounded">
                                <img id="company-logo" alt="" class="avatar-sm company-logo"
                        ...
                        <div class="text-center">
                            <b-link href="#!">
                                <h5 id="overview-companyname" class="overview-companyname">Syntyce Solutions</h5>
                            </b-link>
                            <p id="overview-industryType" class="text-muted overview-industryType">IT Department</p>
                    ...
                    <b-card-body>
                        ...
                        <p id="overview-companydesc" class="text-muted mb-4 overview-companydesc">The IT department of a
                            company
                            ensures that the network of
                            computers within the organisation are well-connected and functioning properly. All the other
                            departments
                            within the company rely on them to ensure that their respective functions can go on
                            seamlessly.</p>
                        ...
                        <div class="table-responsive table-card">
                            <table class="table table-borderless mb-4">
                                ...
                                <tr>
                                    ...
                                    <td id="overview-industryType" class="overview-industryType">Chemical Industries
                                    </td>
                                </tr>
                                <tr>
                                    <td class="fw-medium" scope="row">Location</td>
                                    <td id="overview-company_location" class="overview-company_location">Damascus,
                                        Syria
                                    </td>
                                </tr>
                                <tr>
                                    <td class="fw-medium" scope="row">Employee</td>
                                    <td id="overview-employee" class="overview-employee">10-50</td>
                                </tr>
                                <tr>
                                    <td class="fw-medium" scope="row">Vacancy</td>
                                    <td id="overview-vacancy" class="overview-vacancy">23</td>
                                </tr>
                                <tr>
                                    <td class="fw-medium" scope="row">Rating</td>
                                    <td><span id="overview-rating" class="overview-rating">4.8</span> <i
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <b-link id="overview-website"
                                                class="link-primary text-decoration-underline overview-website"
                                                href="javascript:void(0);">www.syntycesolution.com
                                        </b-link>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="fw-medium" scope="row">Contact Email</td>
                                    <td id="overview-email" class="overview-email">info@syntycesolution.com</td>
                                </tr>
                                <tr>
                                    <td class="fw-medium" scope="row">Since</td>
                                    <td id="overview-since" class="overview-since">1995</td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
                        ...
                        <div class="hstack gap-3">
                            <b-button class="custom-toggle w-100" data-bs-toggle="button" type="button"
                            ...
                            <b-link class="btn btn-primary w-100" href="#!">More View <i
                ...
                <b-card class="overflow-hidden shadow-none" no-body>
                    <b-card-body class="bg-soft-danger">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <b-link class="btn btn-danger" href="/pages/pricing">Upgrade</b-link>
                            </div>
                        </div>
                    </b-card-body>
                    <b-card-body class="bg-soft-danger border-top border-danger border-opacity-25 border-top-dashed">
                        <b-link class="d-flex justify-content-between align-items-center text-body" href="#!">
