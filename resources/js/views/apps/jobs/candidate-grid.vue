...
<template>
    <Layout>
                ...
                <div class="d-md-flex justify-content-sm-end gap-2">
                    <div class="search-box ms-md-2 flex-shrink-0 mb-3 mb-md-0">
                        <input id="searchJob" v-model="searchQuery" autocomplete="off"
                               class="form-control" placeholder="Search for candidate name or designation..."
                               type="text">
        ...
        <b-row id="candidate-list" class="job-list-row">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 ms-3">
                                ...
                                <div class="d-flex flex-wrap gap-2 align-items-center">
                                    <b-badge class="text-bg-success" variant="success"><i class="mdi mdi-star me-1"></i>{{
                                            data.rating
                                        }}
                                    </b-badge>
