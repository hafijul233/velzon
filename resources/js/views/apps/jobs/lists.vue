...
<template>
    <Layout>
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-shrink-0">
                                <b-button variant="primary" @click="createJobModal = !createJobModal"><i
                                    class="ri-add-line align-bottom me-1"></i> Create New Job
                                </b-button>
                            </div>
                        </div>
                        ...
                        <b-row class="mt-3 gy-3">
                            <b-col md="6" xxl="10">
                                <div class="search-box">
                                    <input id="searchJob" v-model="searchQuery" autocomplete="off"
                                           class="form-control search bg-light border-light"
                                           placeholder="Search for jobs or companies..." type="text">
                                    <i class="ri-search-line search-icon"></i>
                                </div>
                            </b-col>
                            <b-col md="6" xxl="2">
                                <div class="input-light">
                                    <select id="idStatus" class="form-control" data-choices
                            ...
                            <b-col v-if="resultQuery >= 0" id="found-job-alert" xl="12">
        ...
        <b-row>
            <b-col xxl="9">
                <div id="job-list">
                    <b-card v-for="(data, index) of resultQuery" :key="index" class="joblist-card" no-body>
                        <b-card-body>
                ...
                <span v-for="(tag, index) of data.tags" :key="index">
                  &nbsp;<b-badge class="badge-soft-primary me-1" variant="soft-primary"> {{ tag }}</b-badge>
                </span>
                            </div>
                        </b-card-body>
                        <b-card-footer class="border-top-dashed">
                            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                                <div><i class="ri-briefcase-2-line align-bottom me-1"></i> <span
                                    class="job-type">{{ data.type }}</span>
                                </div>
                                ...
                                <div><i class="ri-time-line align-bottom me-1"></i> <span class="job-postdate">{{
                                        data.postDate
                                    }}</span>
                                </div>
                                <div>
                                    <b-link class="btn btn-primary viewjob-list" href="#!" @click="showdetail(data)">
                                        View More <i
                ...
                <b-row id="pagination-element" class="g-0 justify-content-end mb-4">
                    <b-col sm="6">
                        <div
                            ...
                            <div class="page-item">
                                <b-link v-if="page != 1" id="page-prev" class="page-link" href="#" @click="page--">
                                    Previous
                                </b-link>
                            </div>
                ...
                <div v-for="(pageNumber, index) in pages" :key="index"
                  ...
                  <b-link class="page-link clickPageNumber" href="javascript:void(0);">{{ pageNumber }}</b-link>
                            ...
                            <div class="page-item">
                                <b-link v-if="page < pages.length" id="page-next" class="page-link" href="#"
                                        @click="page++">Next
                                </b-link>
                            </div>
                        </div>
            ...
            <b-col xxl="3">
                <b-card id="job-overview" class="job-list-view-card overflow-hidden" no-body>
                    <img id="cover-img" alt="" class="img-fluid background object-cover"
                         src="@/assets/images/small/img-10.jpg">
                    <b-card-body>
                        <div class="avatar-md mt-n5">
                            <div class="avatar-title bg-light rounded-circle">
                                <img alt="" class="avatar-xs view-companylogo"
                ...
                <span class="text-muted"><i class="ri-building-line me-1 align-bottom"></i> <span
                    class="view-companyname">Themesbrand</span></span>
                            ...
                            <p class="text-muted view-desc">A UI/UX designer's job is to create user-friendly interfaces
                                that enable
                                users to understand how to use complex technical products. If you're passionate about
                                the latest
                                technology trends and devices, you'll find great fulfillment in being involved in the
                                design process for
                        ...
                        <div class="mt-4">
                            <b-button class="w-100" type="button" variant="success">Apply Now</b-button>
                        </div>
                    </b-card-body>
                </b-card>
            </b-col>
        ...
        <!-- create job modal  -->
        <b-modal id="CreateJobModal" v-model="createJobModal" centered class="v-modal-custom" hide-footer hide-header
            ...
            <b-form id="createjobform" autocomplete="off" class="needs-validation" novalidate>
                ...
                <b-row class="g-3">
                    <b-col lg="12">
                        <div class="px-1 pt-1">
                            <div
                                ...
                                <img id="modal-cover-img" alt="" class="img-fluid"
                                     src="@/assets/images/small/img-9.jpg">

                                <div class="d-flex position-absolute start-0 end-0 top-0 p-3">
                                    <div class="flex-grow-1">
                                        <h5 id="exampleModalLabel" class="modal-title text-white">Create New Job</h5>
                                    </div>
                                    <div class="flex-shrink-0">
                                        <div class="d-flex gap-3 align-items-center">
                                            <div>
                                                <label class="mb-0" data-bs-placement="top" data-bs-toggle="tooltip"
                                            ...
                                            <button id="close-jobListModal" class="btn-close btn-close-white"
                                                    type="button"
                        ...
                        <div class="text-center mb-4 mt-n5 pt-2">
                            <div class="position-relative d-inline-block">
                                <div class="position-absolute bottom-0 end-0">
                                    ...
                                    <input id="companylogo-image-input" accept="image/png, image/gif, image/jpeg"
                        ...
                        <div>
                            <label class="form-label" for="jobtitle-field">Job Title</label>
                            <input id="jobtitle-field" class="form-control" placeholder="Enter job title" required
                                   type="text"/>
                        </div>
                    </b-col>
                    <b-col lg="6">
                        <div>
                            <label class="form-label" for="companyname-field">Company Name</label>
                            <input id="companyname-field" class="form-control" placeholder="Enter company name"
                                   required
                                   type="text"/>
                        </div>
                    </b-col>
                    <b-col lg="6">
                        <div>
                            <label class="form-label" for="job_type-field">Job Type</label>

                            <Multiselect v-model="jobvalue"
                    ...
                    <b-col lg="4">
                        <div>
                            <label class="form-label" for="experience-field">Experience</label>
                            <input id="experience-field" class="form-control" placeholder="Enter experience" required
                                   type="text"/>
                        </div>
                    </b-col>
                    <b-col lg="4">
                        <div>
                            ...
                            <input id="location-field" class="form-control" placeholder="Enter location" required
                                   type="text"/>
                        </div>
                    </b-col>
                    <b-col lg="4">
                        <div>
                            <label class="form-label" for="Salary-field">Salary</label>
                            <input id="Salary-field" class="form-control" placeholder="Enter salary" required
                                   type="number"/>
                        </div>
                    </b-col>
                    <b-col lg="12">
                        <div>
                            <label class="form-label" for="website-field">Tags</label>
                            <Multiselect id="taginput-choices" v-model="tagvalue" :close-on-select="true"
                                         :create-option="false"
                                         :options="tagoption" :searchable="true" mode="tags"/>
                        </div>
                    </b-col>
                    <b-col lg="12">
                        <div>
                            <label class="form-label" for="description-field">Description</label>
                            <textarea id="description-field" class="form-control" placeholder="Enter description"
                                      required
                                      rows="3"></textarea>
                        </div>
                    </b-col>
                ...
                <div class="hstack gap-2 justify-content-end mt-3">
                    <b-button id="edtclosemodal" type="button" variant="light" @click="createJobModal = false">Close
                    </b-button>
                    <b-button id="add-btn" type="button" variant="success" @click="addorder">Add Job</b-button>
                </div>
            </b-form>
        </b-modal>
    </Layout>
