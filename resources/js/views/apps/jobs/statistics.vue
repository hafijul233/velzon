                        ...
                        <div class="flex-grow-1 p-3">
                            ...
                            <p class="mb-0 text-muted">
                                <b-badge class="bg-light text-danger mb-0"><i
                                    class="ri-arrow-down-line align-middle"></i> 3.24 %
                                </b-badge>
                                vs. previous month
                            </p>
                        </div>
        ...
        <b-row>
            <b-col xl="8">
                <b-card no-body>
                    ...
                    <b-card-body>
                        <apexchart :options="visitorgraphchartOptions" :series="visitorgraphseries" class="apex-charts"
                                   dir="ltr"
            ...
            <b-col xl="4">
                <b-card class="card-height-100" no-body>
                    ...
                    <b-card-body>
                        <apexchart :options="userbydevicechartOptions" :series="userbydeviceseries" class="apex-charts"
                                   dir="ltr"
                                   height="219"></apexchart>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <p class="text-muted mb-0">
                                            <UsersIcon class="me-2 icon-sm" height="24" width="24"/>
                                            78.56k
                                        </p>
                                    </td>
                                    <td class="text-end">
            ...
            <b-col md="6" xxl="4">
                <b-card class="card-height-100" no-body>
                    ...
                    <b-card-body class="pb-0">
                        <apexchart :options="yournetworkchartchartOptions" :series="yournetworkchartseries"
                                   class="apex-charts"
                                   dir="ltr"></apexchart>
                    </b-card-body>
                </b-card>
            ...
            <b-col md="6" xxl="8">
                <b-card class="card-height-100" no-body>
                    ...
                    <b-card-body class="px-0">
                        <apexchart :options="jobsummarychartchartOptions" :series="jobsummarychartseries"
                                   class="apex-charts" dir="ltr"
                                   height="320"></apexchart>
                    </b-card-body>
                </b-card>
            </b-col>
        </b-row>
