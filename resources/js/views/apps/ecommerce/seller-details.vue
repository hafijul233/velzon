    ...
    <Layout>
        ...
        <b-row>
            <b-col xxl="3">
                        ...
                        <div>
                            <div class="flex-shrink-0 avatar-md mx-auto">
                                <div class="avatar-title bg-light rounded">
                                    <img alt="" height="50" src="@/assets/images/companies/img-2.png"/>
                                </div>
                            </div>
                            ...
                            <div class="table-responsive">
                                <table class="table mb-0 table-borderless">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <b-link class="link-primary" href="javascript:void(0);">
                ...
                disableOnInteraction: false,
              }" :direction="'vertical'" :loop="true" :mousewheel="true"
                                :slidesPerView="2"
                                :spaceBetween="10" class="vertical-swiper" style="height: 242px">
                            <swiper-slide>
                        ...
                        <div class="text-center mt-3">
                            <b-link class="link-primary" href="javascript:void(0)">View All Reviews
                    ...
                    <b-card-body class="p-4 border-top border-top-dashed">
                        ...
                        <form action="#">
                            <div class="mb-3">
                <textarea id="exampleFormControlTextarea1" class="form-control" placeholder="Enter your messages..."
                          rows="4"></textarea>
                            </div>
                            <div class="text-end">
            ...
            <b-col xxl="9">
                <b-card no-body>
                    <b-card-header class="border-0 align-items-center d-flex">
                        ...
                        <div>
                            <b-button class="me-1" size="sm" type="button" variant="soft-secondary">
                                ALL
                            </b-button>
                            <b-button class="me-1" size="sm" type="button" variant="soft-secondary">
                                1M
                        ...
                        <b-row class="g-0 text-center">
                            <b-col cols="6" sm="3">
                                <div class="p-3 border border-dashed border-start-0">
                                    <h5 class="mb-1">
                                        <count-to :duration="5000" :endVal="7585" :startVal="0"></count-to>
                                    </h5>
                            ...
                            <b-col cols="6" sm="3">
                                <div class="p-3 border border-dashed border-start-0">
                                    <h5 class="mb-1">
                                        $
                                        <count-to :duration="5000" :endVal="22.89" :startVal="0"></count-to>
                                        k
                                    </h5>
                            ...
                            <b-col cols="6" sm="3">
                                <div class="p-3 border border-dashed border-start-0">
                                    <h5 class="mb-1">
                                        <count-to :duration="5000" :endVal="367" :startVal="0"></count-to>
                                    </h5>
                            ...
                            <b-col cols="6" sm="3">
                                <div class="p-3 border border-dashed border-start-0 border-end-0">
                                    <h5 class="mb-1 text-success">
                                        <count-to :duration="5000" :endVal="18.92" :startVal="0"></count-to>
                                        %
                                    </h5>
                ...
                <b-card no-body>
                    <b-card-body>
                            ...
                            <table id="customerTable" class="table align-middle table-nowrap mb-0">
                                ...
                                <tr v-for="(data, index) of resultQuery" :key="index" class="gridjs-tr">
                                    <td class="gridjs-td" data-column-id="productListAllCheckbox">
                                        <input class="gridjs-checkbox" type="checkbox"/>
                                    </td>
                          ...
                          <div class="flex-grow-1">
                            ...
                            <p class="text-muted mb-0">
                              Category : <span class="fw-medium">{{ data.category }}</span>
                                    ...
                                    <td class="gridjs-td" data-column-id="stock">{{ data.stock }}</td>
                                    <td class="gridjs-td" data-column-id="price">{{ data.price }}</td>
                                    <td class="gridjs-td" data-column-id="orders">{{ data.orders }}</td>
                      ...
                      <span>{{ data.publishedDate[0] }}<small class="text-muted ms-1">{{
