...
<template>
  ...
  swiper: thumbnailSwiper,
                                    ...
                                    <swiper :freeMode="true" :loop="false" :modules="[Thumbs]"
                                            :slidesPerView="4"
                                            :spaceBetween="10" class="product-nav-slider mt-2" watch-slides-progress
                            ...
                            <b-col xl="8">
                                <div class="mt-xl-0 mt-5">
                                    <div class="d-flex">
                                        <div class="flex-grow-1">
                                            ...
                                            <div class="hstack gap-3 flex-wrap">
                                                <div>
                                                    <b-link class="text-primary d-block" href="#">Tommy Hilfiger
                                                    </b-link>
                                                </div>
                                                <div class="vr"></div>
                                        ...
                                        <div class="flex-shrink-0">
                                            <div>
                                                <router-link class="btn btn-light" data-bs-placement="top"
                                                             data-bs-toggle="tooltip"
                                                             title="Edit" to="/ecommerce/add-product">
                                    ...
                                    <b-row class="mt-4">
                                        <b-col v-for="(item, index) of productDetailsWidgets" :key="index" lg="3"
                                               sm="6">
                                            ...
                                            <div class="mt-4">
                                                ...
                                                <div class="d-flex flex-wrap gap-2">
                                                    <div v-b-tooltip.hover title="Out of Stock">
                                                        <input id="productsize-radio1" class="btn-check" disabled
                                                    ...
                                                    <div v-b-tooltip.hover title="04 Items Available">
                                                        <input id="productsize-radio2" class="btn-check"
                                                               name="productsize-radio"
                                                               type="radio"/>
                                                        <label
                                                            class="btn btn-soft-primary avatar-xs rounded-circle p-0 d-flex justify-content-center align-items-center"
                                                    ...
                                                    <div v-b-tooltip.hover title="06 Items Available">
                                                        <input id="productsize-radio3" class="btn-check"
                                                               name="productsize-radio"
                                                               type="radio"/>
                                                        <label
                                                            class="btn btn-soft-primary avatar-xs rounded-circle p-0 d-flex justify-content-center align-items-center"
                                                    ...
                                                    <div v-b-tooltip.hover title="Out of Stock">
                                                        <input id="productsize-radio4" class="btn-check" disabled
                                                               name="productsize-radio"
                                                               type="radio"/>
                                                        <label
                                                            class="btn btn-soft-primary avatar-xs rounded-circle p-0 d-flex justify-content-center align-items-center"
                                    ...
                                    <div class="product-content mt-5">
                                        ...
                                        <nav>
                                            <ul id="nav-tab" class="nav nav-tabs nav-tabs-custom nav-success"
                                                role="tablist">
                                                <li class="nav-item">
                                                    <b-link id="nav-speci-tab" aria-controls="nav-speci"
                                                ...
                                                <li class="nav-item">
                                                    <b-link id="nav-detail-tab" aria-controls="nav-detail"
                                                            aria-selected="false"
                                                            class="nav-link"
                                                                ...
                                                                <div class="border border-dashed rounded p-3">
                                                                    <div class="d-flex align-items-start mb-3">
                                                                        <div class="hstack gap-3">
                                                                            <b-badge class="rounded-pill mb-0" tag="div"
                                                                                     variant="success">
